		...
		return elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'nodes',
					A2(elm$json$Json$Encode$list, encodeNode, graph.nodes)),
					_Utils_Tuple2(
					'edges',
...
var author$project$ForceGraph$fromGraph = F2(
	function (nodes, edges) {
		var nodeCount = elm$core$Dict$size(nodes);
		var link = function (_n4) {
			var from = _n4.a;
			var to = _n4.b;
			var distance = function () {
				var _n3 = _Utils_Tuple2(
					A2(elm$core$Dict$get, from, nodes),
					A2(elm$core$Dict$get, to, nodes));
				if ((_n3.a.$ === 'Just') && (_n3.b.$ === 'Just')) {
					var f = _n3.a.a;
					var t = _n3.b.a;
					return 20 + elm$core$Basics$ceiling(f.size + t.size);
				} else {
					return 0;
				}
			}();
		...
		var addNode = F3(
			function (id, _n2, acc) {
				...
				return A2(
					elm$core$List$cons,
					{id: id, size: size, value: value, vx: 0.0, vy: 0.0, x: x, y: y},
					acc);
			});
		return {
			edges: edges,
			nodes: A2(
				...
				newSimulation,
				A3(elm$core$Dict$foldl, addNode, _List_Nil, nodes))
		};
	});
...
var author$project$Main$computeGraph = F2(
	function (cardIdStrs, references) {
		...
		var _n0 = A3(
			...
			_Utils_Tuple3(_List_Nil, elm$core$Dict$empty, elm$core$Dict$empty),
			references);
		var allEdges = _n0.a;
		var incoming = _n0.b;
		var outgoing = _n0.c;
		var size = function (id) {
			return A2(
				...
				A2(
					elm$core$Maybe$withDefault,
					0,
					A2(elm$core$Dict$get, id, incoming)),
				A2(
					elm$core$Maybe$withDefault,
					0,
					A2(elm$core$Dict$get, id, outgoing)));
		};
		var _n3 = A3(
			elm$core$List$foldl,
			F2(
				...
				return ((!A2(elm$core$Dict$member, id, incoming)) && (!A2(elm$core$Dict$member, id, outgoing))) ? A2(
					...
					function (n) {
						return A2(
							...
							A2(elm$core$Dict$singleton, id, n),
							_List_Nil);
					},
					A2(elm$core$Dict$get, id, allNodes)) : elm$core$Maybe$Nothing;
			},
			cardIds);
