...
var author$project$Worker$decodeAndFetchRepo = F3(
	function (nextMsg, payload, model) {
		var _n0 = A2(elm$json$Json$Decode$decodeValue, author$project$Worker$decodeRepoSelector, payload);
		if (_n0.$ === 'Ok') {
			var sel = _n0.a;
			return _Utils_update(
				model,
				...
				switch (msg.a) {
					...
					case 'project_card':
						...
						return A3(
							...
							_Utils_Tuple0,
							function () {
								var _n4 = A2(elm$json$Json$Decode$decodeValue, author$project$Worker$decodeAffectedColumnIds, payload);
								if (_n4.$ === 'Err') {
									var err = _n4.a;
									return A3(
										author$project$Log$debug,
...
var author$project$Worker$init = function (_n0) {
