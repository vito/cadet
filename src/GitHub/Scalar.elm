...
module GitHub.Scalar exposing (Codecs, Date(..), DateTime(..), GitObjectID(..), GitSSHRemote(..), GitTimestamp(..), Html(..), Id(..), PreciseDateTime(..), Uri(..), X509Certificate(..), defaultCodecs, defineCodecs, unwrapCodecs, unwrapEncoder)
...
defineCodecs :
    ...
    -> Codecs valueDate valueDateTime valueGitObjectID valueGitSSHRemote valueGitTimestamp valueHtml valueId valuePreciseDateTime valueUri valueX509Certificate
...
type Codecs valueDate valueDateTime valueGitObjectID valueGitSSHRemote valueGitTimestamp valueHtml valueId valuePreciseDateTime valueUri valueX509Certificate
    = Codecs (RawCodecs valueDate valueDateTime valueGitObjectID valueGitSSHRemote valueGitTimestamp valueHtml valueId valuePreciseDateTime valueUri valueX509Certificate)


type alias RawCodecs valueDate valueDateTime valueGitObjectID valueGitSSHRemote valueGitTimestamp valueHtml valueId valuePreciseDateTime valueUri valueX509Certificate =
    { codecDate : Codec valueDate
    , codecDateTime : Codec valueDateTime
    , codecGitObjectID : Codec valueGitObjectID
    , codecGitSSHRemote : Codec valueGitSSHRemote
...
defaultCodecs : RawCodecs Date DateTime GitObjectID GitSSHRemote GitTimestamp Html Id PreciseDateTime Uri X509Certificate
defaultCodecs =
    { codecDate =
