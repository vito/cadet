...
module GitHub.Enum.RepoCreateAuditEntryVisibility exposing (..)
...
decoder : Decoder RepoCreateAuditEntryVisibility
decoder =
    Decode.string
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid RepoCreateAuditEntryVisibility type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )


{-| Convert from the union type representating the Enum to a string that the GraphQL server will recognize.
-}
toString : RepoCreateAuditEntryVisibility -> String
toString enum =
    case enum of
        Internal ->
            "INTERNAL"
...
-}
fromString : String -> Maybe RepoCreateAuditEntryVisibility
