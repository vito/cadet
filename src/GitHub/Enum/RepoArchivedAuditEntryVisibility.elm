...
module GitHub.Enum.RepoArchivedAuditEntryVisibility exposing (..)
...
decoder : Decoder RepoArchivedAuditEntryVisibility
decoder =
    Decode.string
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid RepoArchivedAuditEntryVisibility type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )


{-| Convert from the union type representating the Enum to a string that the GraphQL server will recognize.
-}
toString : RepoArchivedAuditEntryVisibility -> String
toString enum =
    case enum of
        Internal ->
            "INTERNAL"
...
-}
fromString : String -> Maybe RepoArchivedAuditEntryVisibility
