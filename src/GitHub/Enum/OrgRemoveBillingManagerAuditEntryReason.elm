...
module GitHub.Enum.OrgRemoveBillingManagerAuditEntryReason exposing (..)
...
decoder : Decoder OrgRemoveBillingManagerAuditEntryReason
decoder =
    Decode.string
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid OrgRemoveBillingManagerAuditEntryReason type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )


{-| Convert from the union type representating the Enum to a string that the GraphQL server will recognize.
-}
toString : OrgRemoveBillingManagerAuditEntryReason -> String
toString enum =
    case enum of
        TwoFactorRequirementNonCompliance ->
            "TWO_FACTOR_REQUIREMENT_NON_COMPLIANCE"
...
-}
fromString : String -> Maybe OrgRemoveBillingManagerAuditEntryReason
