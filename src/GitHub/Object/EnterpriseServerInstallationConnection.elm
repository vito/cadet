...
-}
edges :
    SelectionSet decodesTo GitHub.Object.EnterpriseServerInstallationEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) GitHub.Object.EnterpriseServerInstallationConnection
edges object_ =
