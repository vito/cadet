...
-}
edges :
    SelectionSet decodesTo GitHub.Object.CreatedPullRequestContributionEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) GitHub.Object.CreatedPullRequestContributionConnection
edges object_ =
