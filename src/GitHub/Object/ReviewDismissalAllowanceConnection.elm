...
-}
edges :
    SelectionSet decodesTo GitHub.Object.ReviewDismissalAllowanceEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) GitHub.Object.ReviewDismissalAllowanceConnection
edges object_ =
