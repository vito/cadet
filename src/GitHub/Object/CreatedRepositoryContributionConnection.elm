...
-}
edges :
    SelectionSet decodesTo GitHub.Object.CreatedRepositoryContributionEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) GitHub.Object.CreatedRepositoryContributionConnection
edges object_ =
