...
-}
edges :
    SelectionSet decodesTo GitHub.Object.EnterpriseServerUserAccountEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) GitHub.Object.EnterpriseServerUserAccountConnection
edges object_ =
