...
-}
edges :
    SelectionSet decodesTo GitHub.Object.EnterpriseAdministratorInvitationEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) GitHub.Object.EnterpriseAdministratorInvitationConnection
edges object_ =
