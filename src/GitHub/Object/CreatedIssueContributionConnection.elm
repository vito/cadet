...
-}
edges :
    SelectionSet decodesTo GitHub.Object.CreatedIssueContributionEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) GitHub.Object.CreatedIssueContributionConnection
edges object_ =
