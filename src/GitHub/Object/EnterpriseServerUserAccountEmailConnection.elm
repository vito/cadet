...
-}
edges :
    SelectionSet decodesTo GitHub.Object.EnterpriseServerUserAccountEmailEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) GitHub.Object.EnterpriseServerUserAccountEmailConnection
edges object_ =
