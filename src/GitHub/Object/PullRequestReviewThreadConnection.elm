...
-}
edges :
    SelectionSet decodesTo GitHub.Object.PullRequestReviewThreadEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) GitHub.Object.PullRequestReviewThreadConnection
edges object_ =
