...
-}
edges :
    SelectionSet decodesTo GitHub.Object.CreatedPullRequestReviewContributionEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) GitHub.Object.CreatedPullRequestReviewContributionConnection
edges object_ =
