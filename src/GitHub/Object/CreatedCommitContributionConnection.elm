...
-}
edges :
    SelectionSet decodesTo GitHub.Object.CreatedCommitContributionEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) GitHub.Object.CreatedCommitContributionConnection
edges object_ =
