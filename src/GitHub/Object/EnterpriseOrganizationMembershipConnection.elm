...
-}
edges :
    SelectionSet decodesTo GitHub.Object.EnterpriseOrganizationMembershipEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) GitHub.Object.EnterpriseOrganizationMembershipConnection
edges object_ =
