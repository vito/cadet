...
-}
edges :
    SelectionSet decodesTo GitHub.Object.EnterpriseAdministratorEdge
    -> SelectionSet (Maybe (List (Maybe decodesTo))) GitHub.Object.EnterpriseAdministratorConnection
edges object_ =
