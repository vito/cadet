			...
			while (true) {
				...
				if (_p6.ctor === '[]') {
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							start: {line: 1946, column: 25},
							end: {line: 1960, column: 57}
						},
						_p7)('impossible');
				}
			}
	...
	if ((((((((_p13.ctor === 'Just') && (_p13._0.ctor === '::')) && (_p13._0._0.ctor === 'Just')) && (_p13._0._1.ctor === '::')) && (_p13._0._1._0.ctor === 'Just')) && (_p13._0._1._1.ctor === '::')) && (_p13._0._1._1._0.ctor === 'Just')) && (_p13._0._1._1._1.ctor === '[]')) {
		...
		if (((((((_p14.ctor === '::') && (_p14._0.ctor === 'Ok')) && (_p14._1.ctor === '::')) && (_p14._1._0.ctor === 'Ok')) && (_p14._1._1.ctor === '::')) && (_p14._1._1._0.ctor === 'Ok')) && (_p14._1._1._1.ctor === '[]')) {
			...
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 1873, column: 17},
					end: {line: 1881, column: 50}
				},
				_p14)('invalid hex');
		}
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 1871, column: 9},
				end: {line: 1884, column: 42}
			},
			_p13)('invalid hex');
	}
};
			...
			function (i, _p32) {
				...
				if ((_p36.ctor === '::') && (_p36._1.ctor === '[]')) {
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							start: {line: 1462, column: 17},
							end: {line: 1467, column: 49}
						},
						_p36)('impossible');
				}
			});
															...
															_elm_lang$html$Html$span,
															{
																...
																_1: {
																	...
																	_0: _elm_lang$html$Html_Events$onClick(
																		_vito$cadet$Main$SetLabelColor(_p87)),
																	_1: {
																		ctor: '::',
																		_0: _vito$cadet$Main$labelColorStyle(_p87),
																		_1: {ctor: '[]'}
															...
															_0: A2(
																...
																},
																{
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(_p88),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}),
													...
													_elm_lang$html$Html$form,
													{
														...
														_1: {
															...
															_0: _elm_lang$html$Html_Events$onSubmit(
																A2(_vito$cadet$Main$EditLabel, _p88, _p87)),
															_1: {ctor: '[]'}
														}
													},
													{
														...
														_0: A2(
															_elm_lang$html$Html$span,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onClick(
																		A2(_vito$cadet$Main$RandomizeLabelColor, _p88, _p87)),
																	_1: {
																		ctor: '::',
																		_0: _vito$cadet$Main$labelColorStyle(_p86),
																		_1: {ctor: '[]'}
																	}
																}
															},
															...
															_0: A2(
																_elm_lang$html$Html$input,
																{
																	...
																	_0: _elm_lang$html$Html_Events$onInput(
																		A2(_vito$cadet$Main$SetLabelName, _p88, _p87)),
																	_1: {
																		ctor: '::',
										...
										},
										{
											...
											_0: _elm_lang$html$Html$text(
												A2(
													_elm_lang$core$Basics_ops['++'],
													_elm_lang$core$Basics$toString(
														_elm_lang$core$List$length(_p84._1)),
													' repos')),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
											...
											},
											{
												...
												_0: A2(
													_elm_lang$html$Html$span,
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															A2(_vito$cadet$Main$MirrorLabel, _p88, _p87)),
														_1: {
															ctor: '::',
												...
												_1: {
													...
													_0: A2(
														...
														_elm_lang$html$Html$span,
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(
																A2(_vito$cadet$Main$StopEditingLabel, _p88, _p87)),
															_1: {
																ctor: '::',
														...
														_elm_lang$html$Html$span,
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(
																A2(_vito$cadet$Main$StartEditingLabel, _p88, _p87)),
															_1: {
																ctor: '::',
													...
													_1: {
														...
														_0: A2(
															...
															_elm_lang$html$Html$span,
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(
																	A2(_vito$cadet$Main$StopDeletingLabel, _p88, _p87)),
																_1: {
																	ctor: '::',
															...
															_elm_lang$html$Html$span,
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(
																	A2(_vito$cadet$Main$StartDeletingLabel, _p88, _p87)),
																_1: {
																	ctor: '::',
													...
													},
													{
														...
														_0: isDeleting ? A2(
															_elm_lang$html$Html$span,
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(
																	A2(_vito$cadet$Main$DeleteLabel, _p88, _p87)),
																_1: {
																	ctor: '::',
...
var _vito$cadet$Main$viewCardNodeFlair = F5(
	function (card, radii, flair, _p89, state) {
		var _p90 = _p89;
		var projectHalo = A2(
			...
			_elm_lang$svg$Svg$g,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$transform(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_p90.x),
							A2(
								_elm_lang$core$Basics_ops['++'],
								', ',
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(_p90.y),
									A2(
										_elm_lang$core$Basics_ops['++'],
										') scale(',
...
var _vito$cadet$Main$viewCardNode = F5(
	function (card, radii, labels, _p91, state) {
		var _p92 = _p91;
		var circleWithNumber = function () {
			var _p93 = card.state;
			if (_p93.ctor === 'IssueState') {
				return {
					ctor: '::',
					_0: A2(
						_elm_lang$svg$Svg$circle,
			...
			_elm_lang$svg$Svg$g,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$transform(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_p92.x),
							A2(
								_elm_lang$core$Basics_ops['++'],
								', ',
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(_p92.y),
									A2(
										_elm_lang$core$Basics_ops['++'],
										') scale(',
										A2(_elm_lang$core$Basics_ops['++'], scale, ')'))))))),
...
var _vito$cadet$Main$cardNode = F2(
	function (card, context) {
		...
		return {
			...
			bounds: function (_p94) {
				var _p95 = _p94;
				var _p97 = _p95.y;
				var _p96 = _p95.x;
				return {x1: _p96 - radii.withFlair, y1: _p97 - radii.withFlair, x2: _p96 + radii.withFlair, y2: _p97 + radii.withFlair};
			},
			score: card.score
		};
	});
var _vito$cadet$Main$computeReferenceGraph = F2(
	function (data, cards) {
		var applyWithContext = function (_p98) {
			var _p99 = _p98;
			var _p100 = _p99.node;
			var context = {incoming: _p99.incoming, outgoing: _p99.outgoing};
			return _elm_lang$core$Native_Utils.update(
				_p99,
				{
					node: _elm_lang$core$Native_Utils.update(
					...
					},
					{
						...
						_0: function () {
							...
							if (_p101.ctor === 'IssueState') {
								if (_p101._0.ctor === 'IssueStateOpen') {
									return A2(
										_elm_lang$html$Html$span,
										{
											ctor: '::',
															...
															_0: function () {
																...
																if (_p102.ctor === 'Just') {
																	...
																	return A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$href(_p103.url),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$target('_blank'),
																				_1: {
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(_p103.login),
																			_1: {ctor: '[]'}
																		});
																} else {
...
var _vito$cadet$Main$moveCard = F3(
	function (model, _p104, cardId) {
		var _p105 = _p104;
		var _p107 = _p105.columnId;
		var _p106 = model.me;
		if (_p106.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$CardMoved(_p107),
				A4(_vito$cadet$GitHubGraph$moveCardAfter, _p106._0.token, _p107, cardId, _p105.afterId));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
var _vito$cadet$Main$addCard = F3(
	function (model, _p108, contentId) {
		var _p109 = _p108;
		var _p114 = _p109.columnId;
		var _p113 = _p109.afterId;
		var _p110 = model.me;
		if (_p110.ctor === 'Just') {
			var _p112 = _p110._0.token;
			var _p111 = A3(_vito$cadet$Main$contentCardId, model, _p109.projectId, contentId);
			if (_p111.ctor === 'Just') {
				return A2(
					_elm_lang$core$Task$attempt,
					_vito$cadet$Main$CardMoved(_p114),
					A4(_vito$cadet$GitHubGraph$moveCardAfter, _p112, _p114, _p111._0, _p113));
			} else {
				return A2(
					_elm_lang$core$Task$attempt,
					_vito$cadet$Main$CardMoved(_p114),
					A4(_vito$cadet$GitHubGraph$addContentCardAfter, _p112, _p114, contentId, _p113));
			}
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
			...
			switch (_p115.ctor) {
							...
							switch (_p116.ctor) {
								...
								case 'ProjectPage':
									return A2(
										...
										A2(
											_elm_lang$core$List$filter,
											_vito$cadet$Main$isInProject(_p116._0),
											cards));
								default:
									return {ctor: '[]'};
							}
				...
				case 'SetCurrentDate':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{currentDate: _p115._0}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Drag':
					var dragModel = A2(_vito$cadet$Drag$update, _p115._0, model.drag);
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{drag: dragModel});
					var _p118 = dragModel;
					if (_p118.ctor === 'Dropped') {
						var _v62 = _p118._0.msg,
							_v63 = newModel;
						msg = _v62;
						model = _v63;
						continue update;
				...
				case 'MoveCardAfter':
					var _p120 = _p115._1;
					var _p119 = _p115._0;
					if (_p119.ctor === 'FromColumnCardSource') {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A3(_vito$cadet$Main$moveCard, model, _p120, _p119._0.cardId)
						};
					} else {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A3(_vito$cadet$Main$addCard, model, _p120, _p119._0.contentId)
						};
					}
				case 'CardMoved':
					if (_p115._1.ctor === 'Ok') {
						var _p124 = _p115._0;
						var _p121 = model.drag;
						if (_p121.ctor === 'Dropped') {
							...
							var _p122 = _p121._0.source;
							if (_p122.ctor === 'FromColumnCardSource') {
								var _p123 = _p122._0;
								return _elm_lang$core$Native_Utils.eq(_p123.columnId, _p124) ? A3(refresh, false, _p124, model) : {
									ctor: '_Tuple2',
									_0: model,
									_1: A2(
										_vito$cadet$Backend$refreshCards,
										...
										A2(
											...
											A2(refresh, true, _p123.columnId),
											_p124))
								};
							} else {
								return A3(refresh, false, _p124, model);
							}
						} else {
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						}
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to move card', _p115._1._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'CardsFetched':
					if (_p115._2.ctor === 'Ok') {
						var _p125 = _p115._2._0;
						var data = model.data;
						return _p115._0(
							_elm_lang$core$Native_Utils.update(
								model,
								{
									data: _elm_lang$core$Native_Utils.update(
										data,
										{
											cards: A3(_elm_lang$core$Dict$insert, _p115._1, _p125, data.cards)
										}),
									allCards: A2(_vito$cadet$Main$addProjectCards, _p125, model.allCards)
								}));
					} else {
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to refresh cards', _p115._2._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'SearchCards':
					if (_p115._0 === '') {
						...
						var cardMatch = function (_p126) {
							var _p127 = _p126;
							return A2(
								_elm_lang$core$String$contains,
								_elm_lang$core$String$toLower(_p115._0),
								_elm_lang$core$String$toLower(_p127.title)) ? _elm_lang$core$Maybe$Just(_p127.id) : _elm_lang$core$Maybe$Nothing;
						};
						var foundCards = A2(
							_elm_lang$core$List$filterMap,
							cardMatch,
				...
				case 'SelectCard':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								selectedCards: A2(_elm_lang$core$List$member, _p128, model.selectedCards) ? model.selectedCards : A2(
									_elm_lang$core$Basics_ops['++'],
									model.selectedCards,
									{
										ctor: '::',
				...
				case 'HighlightNode':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								highlightedNode: _elm_lang$core$Maybe$Just(_p115._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				...
				case 'AnticipateCardFromNode':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								anticipatedCards: {ctor: '::', _0: _p129, _1: model.anticipatedCards},
								highlightedCard: _elm_lang$core$Maybe$Just(_p129)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				...
				case 'MeFetched':
					if (_p115._0.ctor === 'Ok') {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'error fetching self', _p115._0._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'DataFetched':
					if (_p115._0.ctor === 'Ok') {
						var _p132 = _p115._0._0;
						var withIssues = A3(
							_elm_lang$core$Dict$foldl,
							F3(
								function (_p130, is, cards) {
									return A3(
										_elm_lang$core$List$foldl,
										function (i) {
											return A2(
						...
						var allCards = A3(
							...
							withPRs,
							_elm_lang$core$Dict$values(_p132.cards));
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'error fetching data', _p115._0._0),
							{
								ctor: '_Tuple2',
								_0: model,
								_1: _vito$cadet$Backend$pollData(_vito$cadet$Main$DataFetched)
				...
				case 'MirrorLabel':
					var _p137 = _p115._0;
					var _p136 = _p115._1;
					var newLabel = {name: _p137, color: _p136};
					var cmds = A2(
						_elm_lang$core$List$map,
						function (r) {
							var _p134 = A2(
							...
							if (_p134.ctor === '[]') {
								...
								var _p135 = _p134._0;
								return (!_elm_lang$core$Native_Utils.eq(_p135.color, _p136)) ? A4(_vito$cadet$Main$updateLabel, model, r, _p135, newLabel) : _elm_lang$core$Platform_Cmd$none;
							}
						},
						model.data.repos);
					return {
					...
					var cmds = A2(
						...
						function (r) {
							...
							if (_p139.ctor === '[]') {
								...
								var _p140 = _p139._0;
								return _elm_lang$core$Native_Utils.eq(_p140.color, _p141) ? A3(_vito$cadet$Main$deleteLabel, model, r, _p140) : _elm_lang$core$Platform_Cmd$none;
							}
						},
						model.data.repos);
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								deletingLabels: A2(
									_elm_lang$core$Set$remove,
									{ctor: '_Tuple2', _0: _p142, _1: _p141},
									model.deletingLabels)
							}),
						_1: _elm_lang$core$Platform_Cmd$batch(cmds)
					};
							...
							model,
							{
								editingLabels: A3(
									...
									_elm_lang$core$Maybe$map(
										function (_p145) {
											var _p146 = _p145;
											return {ctor: '_Tuple2', _0: _p115._2, _1: _p146._1};
										}),
									model.editingLabels)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								editingLabels: A2(
									_elm_lang$core$Dict$map,
									F2(
										function (_p148, _p147) {
											var _p149 = _p147;
											return {ctor: '_Tuple2', _0: _p149._0, _1: _p115._0};
										}),
									model.editingLabels)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
				...
				case 'RandomizeLabelColor':
					...
					var _p150 = A2(
						_elm_lang$core$Dict$get,
						{ctor: '_Tuple2', _0: _p153, _1: _p152},
						model.editingLabels);
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									editingLabels: A3(
										_elm_lang$core$Dict$insert,
										{ctor: '_Tuple2', _0: _p153, _1: _p152},
										{ctor: '_Tuple2', _0: _p150._0._0, _1: randomHex},
										model.editingLabels)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
				...
				case 'EditLabel':
					...
					var _p154 = A2(
						_elm_lang$core$Dict$get,
						{ctor: '_Tuple2', _0: _p156, _1: _p155},
						model.editingLabels);
					if (_p154.ctor === 'Nothing') {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					} else {
						var newLabel = {name: _p154._0._0, color: _p154._0._1};
						var oldLabel = {name: _p156, color: _p155};
						var cmds = A2(
							_elm_lang$core$List$map,
							function (r) {
								return A2(_elm_lang$core$List$member, oldLabel, r.labels) ? A4(_vito$cadet$Main$updateLabel, model, r, oldLabel, newLabel) : _elm_lang$core$Platform_Cmd$none;
							},
							model.data.repos);
						return {
							ctor: '_Tuple2',
				...
				case 'LabelChanged':
					if (_p115._1.ctor === 'Ok') {
						var _p157 = _p115._0;
						var repoSel = {owner: _p157.owner, name: _p157.name};
						return {
							ctor: '_Tuple2',
							_0: model,
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to modify labels', _p115._1._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				default:
					if (_p115._0.ctor === 'Ok') {
						var _p158 = _p115._0._0;
						var data = model.data;
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
									...
									data: _elm_lang$core$Native_Utils.update(
										data,
										{
											repos: A2(
												_elm_lang$core$List$map,
												function (r) {
													return _elm_lang$core$Native_Utils.eq(r.id, _p158.id) ? _p158 : r;
												},
												data.repos)
										})
								}),
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to refresh repo', _p115._0._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
			}
		}
...
var _vito$cadet$Main$viewProjectColumnCard = F4(
	function (model, project, col, ghCard) {
		...
		var _p159 = {ctor: '_Tuple2', _0: ghCard.note, _1: ghCard.content};
		_v74_2:
		do {
			if (_p159.ctor === '_Tuple2') {
				if (_p159._0.ctor === 'Just') {
					if (_p159._1.ctor === 'Nothing') {
						return {
							...
							_0: A4(
								...
								dragId,
								A3(_vito$cadet$Main$viewNoteCard, model, col, _p159._0._0)),
							_1: {
								ctor: '::',
								_0: A4(
					...
					if (_p159._1.ctor === 'Just') {
						var card = function () {
							var _p160 = _p159._1._0;
							if (_p160.ctor === 'IssueCardContent') {
								return _vito$cadet$Main$issueCard(_p160._0);
							} else {
								return _vito$cadet$Main$prCard(_p160._0);
							}
						}();
						return {
							ctor: '::',
		...
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 1100, column: 9},
				end: {line: 1121, column: 41}
			},
			_p159)('impossible');
	});
...
var _vito$cadet$Main$viewSingleProject = F2(
	function (model, _p162) {
		var _p163 = _p162;
		var _p164 = _p163.project;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
						...
						_elm_lang$core$Basics_ops['++'],
						{
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(_p164.name),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: A4(_vito$cadet$Main$viewProjectColumn, model, _p164, _vito$cadet$Main$onlyOpenContentCards, _p163.done),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: A4(_vito$cadet$Main$viewProjectColumn, model, _p164, _elm_lang$core$Basics$identity, _p163.inFlight),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						A3(
							...
							function (backlog) {
								return A2(
									...
									{
										ctor: '::',
										_0: A4(_vito$cadet$Main$viewProjectColumn, model, _p164, _elm_lang$core$Basics$identity, backlog),
										_1: {ctor: '[]'}
									});
							}))),
				_1: {
						...
						},
						{
							...
							_1: {
								...
								_0: function () {
									var dropCandidate = {
										msgFunc: _vito$cadet$Main$MoveCardAfter,
										target: {projectId: _p164.id, columnId: _p163.icebox.id, afterId: _elm_lang$core$Maybe$Nothing}
									};
...
var _vito$cadet$Main$viewProjectPage = F2(
	function (model, name) {
		...
		var _p166 = mproject;
		if (_p166.ctor === 'Just') {
			return A2(_vito$cadet$Main$viewSingleProject, model, _p166._0);
		} else {
			...
			_0: A2(
				...
				function (_p167) {
					return _vito$cadet$Main$SetCurrentDate(
						_elm_lang$core$Date$fromTime(_p167));
				}),
			_1: {
				ctor: '::',
										...
										_0: A2(
											_elm_lang$html$Html$a,
											{
												...
												_0: _elm_lang$html$Html_Attributes$href(
													A2(_elm_lang$core$Basics_ops['++'], '/projects/', _p170.name)),
												_1: {
													ctor: '::',
													_0: _vito$cadet$StrictEvents$onLeftClick(
														_vito$cadet$Main$SetPage(
															_vito$cadet$Main$ProjectPage(_p170.name))),
													_1: {ctor: '[]'}
												}
											},
											{
	...
	var page = function () {
		...
		do {
			if (_p171.ctor === '[]') {
				...
				if (_p171._1.ctor === '::') {
					if ((_p171._0 === 'projects') && (_p171._1._1.ctor === '[]')) {
						return _vito$cadet$Main$SetPage(
							_vito$cadet$Main$ProjectPage(_p171._1._0));
					} else {
						break _v79_4;
					}
				} else {
								...
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$img,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$src(_p173.avatar),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
	...
	var anticipatedCards = A2(
		...
		A2(
			...
			A2(
				_elm_lang$core$List$filter,
				function (_p174) {
					return !A3(_elm_lang$core$Basics$flip, _elm_lang$core$List$member, model.selectedCards, _p174);
				},
				model.anticipatedCards)));
						...
						},
						{
							...
							_0: function () {
								...
								switch (_p175.ctor) {
									...
									case 'ProjectPage':
										return A2(_vito$cadet$Main$viewProjectPage, model, _p175._0);
									default:
