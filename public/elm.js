	...
	if ((((((((_p9.ctor === 'Just') && (_p9._0.ctor === '::')) && (_p9._0._0.ctor === 'Just')) && (_p9._0._1.ctor === '::')) && (_p9._0._1._0.ctor === 'Just')) && (_p9._0._1._1.ctor === '::')) && (_p9._0._1._1._0.ctor === 'Just')) && (_p9._0._1._1._1.ctor === '[]')) {
		...
		if (((((((_p10.ctor === '::') && (_p10._0.ctor === 'Ok')) && (_p10._1.ctor === '::')) && (_p10._1._0.ctor === 'Ok')) && (_p10._1._1.ctor === '::')) && (_p10._1._1._0.ctor === 'Ok')) && (_p10._1._1._1.ctor === '[]')) {
			...
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 1151, column: 17},
					end: {line: 1159, column: 50}
				},
				_p10)('invalid hex');
		}
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 1149, column: 9},
				end: {line: 1162, column: 42}
			},
			_p9)('invalid hex');
	}
};
...
var _vito$cadet$Main$Model = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {config: a, page: b, currentDate: c, data: d, allCards: e, selectedCards: f, anticipatedCards: g, cardGraphs: h, computeGraph: i};
	});
			...
			default:
				if (_p80._0.ctor === 'Ok') {
					...
					return A3(
						_elm_lang$core$Basics$flip,
						_elm_lang$core$Basics$always,
						A2(_elm_lang$core$Debug$log, 'error', _p80._0._0),
...
var _vito$cadet$Main$viewProjectColumnCard = F2(
	function (model, _p91) {
		...
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 549, column: 5},
				end: {line: 563, column: 37}
			},
			_p93)('impossible');
	});
