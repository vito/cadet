			...
			while (true) {
				...
				if (_p2.ctor === '[]') {
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							start: {line: 1606, column: 25},
							end: {line: 1620, column: 57}
						},
						_p3)('impossible');
				}
			}
	...
	if ((((((((_p9.ctor === 'Just') && (_p9._0.ctor === '::')) && (_p9._0._0.ctor === 'Just')) && (_p9._0._1.ctor === '::')) && (_p9._0._1._0.ctor === 'Just')) && (_p9._0._1._1.ctor === '::')) && (_p9._0._1._1._0.ctor === 'Just')) && (_p9._0._1._1._1.ctor === '[]')) {
		...
		if (((((((_p10.ctor === '::') && (_p10._0.ctor === 'Ok')) && (_p10._1.ctor === '::')) && (_p10._1._0.ctor === 'Ok')) && (_p10._1._1.ctor === '::')) && (_p10._1._1._0.ctor === 'Ok')) && (_p10._1._1._1.ctor === '[]')) {
			...
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 1532, column: 17},
					end: {line: 1540, column: 50}
				},
				_p10)('invalid hex');
		}
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 1530, column: 9},
				end: {line: 1543, column: 42}
			},
			_p9)('invalid hex');
	}
};
			...
			function (i, _p28) {
				...
				if ((_p32.ctor === '::') && (_p32._1.ctor === '[]')) {
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							start: {line: 1204, column: 17},
							end: {line: 1209, column: 49}
						},
						_p32)('impossible');
				}
			});
				...
				if (_p70.ctor === 'Nothing') {
					...
					if (_p70._0.ctor === 'IssueCardContent') {
						...
						return A2(
							_elm_lang$core$Dict$insert,
							_p71.id,
							_vito$cadet$Main$issueCard(_p71));
					} else {
						var _p72 = _p70._0._0;
						return A2(
							_elm_lang$core$Dict$insert,
							_p72.id,
							_vito$cadet$Main$prCard(_p72));
					}
				}
			},
			allCards,
							...
							_1: {
								...
								_1: {
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'in-flight',
										_1: _elm_lang$core$Native_Utils.eq(col.name, 'In Flight')
									},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'done',
											_1: _elm_lang$core$Native_Utils.eq(col.name, 'Done')
										},
										_1: {
											ctor: '::',
											_0: {
												ctor: '_Tuple2',
												_0: 'backlog',
												_1: _elm_lang$core$Native_Utils.eq(col.name, 'Backlog')
											},
											_1: {ctor: '[]'}
										}
									}
...
var _vito$cadet$Main$viewProjectColumnCard = F3(
	function (model, col, ghCard) {
		...
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 861, column: 9},
				end: {line: 882, column: 41}
			},
			_p121)('impossible');
	});
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: A3(_vito$cadet$Main$viewProjectColumn, model, _elm_lang$core$Maybe$Nothing, _p125.backlog),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
