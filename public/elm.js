			...
			while (true) {
				...
				if (_p7.ctor === '[]') {
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							start: {line: 2764, column: 25},
							end: {line: 2778, column: 57}
						},
						_p8)('impossible');
				}
			}
	...
	if ((((((((_p14.ctor === 'Just') && (_p14._0.ctor === '::')) && (_p14._0._0.ctor === 'Just')) && (_p14._0._1.ctor === '::')) && (_p14._0._1._0.ctor === 'Just')) && (_p14._0._1._1.ctor === '::')) && (_p14._0._1._1._0.ctor === 'Just')) && (_p14._0._1._1._1.ctor === '[]')) {
		...
		if (((((((_p15.ctor === '::') && (_p15._0.ctor === 'Ok')) && (_p15._1.ctor === '::')) && (_p15._1._0.ctor === 'Ok')) && (_p15._1._1.ctor === '::')) && (_p15._1._1._0.ctor === 'Ok')) && (_p15._1._1._1.ctor === '[]')) {
			...
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 2682, column: 17},
					end: {line: 2690, column: 50}
				},
				_p15)('invalid hex');
		}
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 2680, column: 9},
				end: {line: 2693, column: 42}
			},
			_p14)('invalid hex');
	}
};
...
var _vito$cadet$Main$lastActivityIsByUser = F3(
	function (cardEvents, login, card) {
		...
		if (_p25.ctor === 'Just') {
			return _elm_lang$core$Native_Utils.eq(_p25._0.actor.login, login);
		} else {
			return false;
		}
	});
			...
			_elm_lang$html$Html$img,
			{
				...
				_0: _elm_lang$html$Html_Attributes$class(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'card-actor ',
						A2(_vito$cadet$Main$activityClass, model.currentDate, _p29.createdAt))),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$src(
						A2(_elm_lang$core$Basics_ops['++'], _p29.actor.avatar, '&s=88')),
					_1: {
						ctor: '::',
...
var _vito$cadet$Main$issueRadius = F2(
	function (card, _p30) {
		...
		return 15 + ((_elm_lang$core$Basics$toFloat(
			_elm_community$intdict$IntDict$size(_p31.incoming)) / 2) + _elm_lang$core$Basics$toFloat(
			_elm_community$intdict$IntDict$size(_p31.outgoing) * 2));
	});
	...
	function (card, context) {
		...
		var emojiReactions = A3(
			...
			function (_p33) {
				...
				return {
					ctor: '_Tuple2',
					_0: reactionTypeEmoji(_p34.type_),
					_1: _p34.count
				};
			});
		var flairs = A2(
			...
			function (i, _p36) {
				...
				var segments = A2(
					_gampleman$elm_visualization$Visualization_Shape$pie,
					{
						...
						innerRadius: radius,
						outerRadius: (radius + _vito$cadet$Main$flairRadiusBase) + _elm_lang$core$Basics$toFloat(_p37._1),
						cornerRadius: 3,
						padRadius: 0
					},
					A2(
				...
				if ((_p40.ctor === '::') && (_p40._1.ctor === '[]')) {
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							start: {line: 2150, column: 17},
							end: {line: 2155, column: 49}
						},
						_p40)('impossible');
				}
			});
		return A3(
			...
			F2(
				function (i, _p42) {
					var _p43 = _p42;
					var arc = A2(reactionSegment, i, _p43);
					return A2(
						_elm_lang$svg$Svg$g,
						{
							ctor: '::',
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$svg$Svg$text(_p43._0),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _vito$cadet$Main$linkPath = F2(
	function (graph, edge) {
		var target = function () {
			...
			if (_p47.ctor === 'Just') {
				return {x: _p47._0.x, y: _p47._0.y};
			} else {
				return {x: 0, y: 0};
			}
		}();
...
var _vito$cadet$Main$viewNodeLowerUpper = F3(
	function (state, _p51, _p50) {
		var _p52 = _p51;
		var _p54 = _p52.node;
		var _p53 = _p50;
		var pos = {x: _p54.label.x, y: _p54.label.y};
		return {
			ctor: '_Tuple2',
			_0: {
				ctor: '::',
				_0: A3(_elm_lang$svg$Svg_Lazy$lazy2, _p54.label.value.viewLower, pos, state),
				_1: _p53._0
			},
			_1: {
				ctor: '::',
				_0: A3(_elm_lang$svg$Svg_Lazy$lazy2, _p54.label.value.viewUpper, pos, state),
				_1: _p53._1
			}
		};
	});
	...
	function (model, _p55) {
		...
		var links = A2(
			...
			_elm_lang$svg$Svg_Lazy$lazy(
				_vito$cadet$Main$linkPath(_p66)),
			_elm_community$graph$Graph$edges(_p66));
		var padding = 10;
		var nodeContexts = A3(
			_elm_community$graph$Graph$fold,
			F2(
		...
		var minX = A3(
			...
			F2(
				function (_p58, acc) {
					var _p59 = _p58;
					return A2(_elm_lang$core$Basics$min, _p59.x1, acc);
				}),
			999999,
			bounds) - padding;
		var minY = A3(
			...
			F2(
				function (_p60, acc) {
					var _p61 = _p60;
					return A2(_elm_lang$core$Basics$min, _p61.y1, acc);
				}),
			999999,
			bounds) - padding;
		var maxX = A3(
			...
			F2(
				function (_p62, acc) {
					var _p63 = _p62;
					return A2(_elm_lang$core$Basics$max, _p63.x2, acc);
				}),
			0,
			bounds) + padding;
		var width = maxX - minX;
		var maxY = A3(
			...
			F2(
				function (_p64, acc) {
					var _p65 = _p64;
					return A2(_elm_lang$core$Basics$max, _p65.y2, acc);
				}),
			0,
			bounds) + padding;
...
var _vito$cadet$Main$satisfiesFilter = F3(
	function (model, filter, card) {
		...
		switch (_p72.ctor) {
			...
			case 'HasLabelFilter':
				return A3(_vito$cadet$Main$hasLabel, model, _p72._0, card);
			default:
	...
	return _elm_lang$core$List$filter(
		function (_p73) {
			...
			if (_p75.ctor === 'Just') {
				...
				if (_p76.ctor === 'Just') {
					var _p77 = _p76._0;
					return _vito$cadet$Main$isOpen(_p77) || A2(_vito$cadet$Main$needsAcceptance, model, _p77);
				} else {
					return false;
				}
			} else {
...
var _vito$cadet$Main$selectStatefulProject = function (project) {
	...
	var _p81 = {ctor: '_Tuple4', _0: icebox, _1: backlogs, _2: inFlights, _3: dones};
	if ((((((((_p81.ctor === '_Tuple4') && (_p81._0.ctor === '::')) && (_p81._0._1.ctor === '[]')) && (_p81._1.ctor === '::')) && (_p81._2.ctor === '::')) && (_p81._2._1.ctor === '[]')) && (_p81._3.ctor === '::')) && (_p81._3._1.ctor === '[]')) {
		return _elm_lang$core$Maybe$Just(
			{project: project, icebox: _p81._0._0, backlogs: _p81._1, inFlight: _p81._2._0, done: _p81._3._0});
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
																		...
																		return function (s) {
																			return function (t) {
																				return function (u) {
																					return function (v) {
																						return function (w) {
																							return {config: a, me: b, page: c, currentDate: d, projectDrag: e, milestoneDrag: f, data: g, dataView: h, allCards: i, allLabels: j, selectedCards: k, anticipatedCards: l, highlightedCard: m, highlightedNode: n, baseGraphFilter: o, graphFilters: p, graphSort: q, cardGraphs: r, deletingLabels: s, editingLabels: t, newLabel: u, newLabelColored: v, newMilestoneName: w};
																						};
																					};
																				};
																			};
...
var _vito$cadet$Main$HasLabelFilter = function (a) {
	return {ctor: 'HasLabelFilter', _0: a};
};
...
var _vito$cadet$Main$prCard = function (_p82) {
	var _p83 = _p82;
	var _p84 = _p83;
	return {
		id: _p83.id,
		content: _vito$cadet$GitHubGraph$PullRequestCardContent(_p84),
		url: _p83.url,
		repo: _p83.repo,
		number: _p83.number,
		title: _p83.title,
		updatedAt: _p83.updatedAt,
		author: _p83.author,
		labels: A2(
			_elm_lang$core$List$map,
			function (_) {
			...
			_p83.labels),
		cards: _p83.cards,
		commentCount: _p83.commentCount,
		reactions: _p83.reactions,
		score: _vito$cadet$GitHubGraph$pullRequestScore(_p84),
		state: _vito$cadet$Main$PullRequestState(_p83.state),
		milestone: _p83.milestone
	};
};
...
var _vito$cadet$Main$issueCard = function (_p93) {
	var _p94 = _p93;
	var _p95 = _p94;
	return {
		id: _p94.id,
		content: _vito$cadet$GitHubGraph$IssueCardContent(_p95),
		url: _p94.url,
		repo: _p94.repo,
		number: _p94.number,
		title: _p94.title,
		...
		score: _vito$cadet$GitHubGraph$issueScore(_p95),
		state: _vito$cadet$Main$IssueState(_p94.state),
				...
				},
				{
					...
					_1: {
						...
						_0: function () {
							var _p96 = model.me;
							if (_p96.ctor === 'Just') {
								var filter = _vito$cadet$Main$InvolvesUserFilter(_p96._0.user.login);
								return A2(
									_elm_lang$html$Html$div,
									{
										ctor: '::',
	...
	function (model, pr, mmilestone) {
		...
		if (_p97.ctor === 'Just') {
			return A2(
				...
				A3(_vito$cadet$GitHubGraph$setPullRequestMilestone, _p97._0.token, pr, mmilestone));
		} else {
	...
	function (model, issue, mmilestone) {
		...
		if (_p98.ctor === 'Just') {
			return A2(
				...
				A3(_vito$cadet$GitHubGraph$setIssueMilestone, _p98._0.token, issue, mmilestone));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, title) {
		...
		if (_p99.ctor === 'Just') {
			return A2(
				...
				A3(_vito$cadet$GitHubGraph$createRepoMilestone, _p99._0.token, repo, title));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, milestone) {
		...
		if (_p100.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$MilestoneChanged(repo),
				A3(_vito$cadet$GitHubGraph$closeRepoMilestone, _p100._0.token, repo, milestone));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, milestone) {
		...
		if (_p101.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$MilestoneChanged(repo),
				A3(_vito$cadet$GitHubGraph$deleteRepoMilestone, _p101._0.token, repo, milestone));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
		...
		if (_p102.ctor === 'Just') {
			...
			var reopen = A2(
				...
				A2(
					_elm_lang$core$Task$mapError,
					_elm_lang$core$Basics$toString,
					A2(_vito$cadet$GitHubGraph$reopenIssue, _p106, issue)));
			var addLabel = A2(
				_elm_lang$core$Task$map,
				_elm_lang$core$Basics$always(
					{ctor: '_Tuple0'}),
			...
			return A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$Task$andThen,
						function (_p109) {
							return A2(_vito$cadet$GitHubGraph$closeIssue, _p111, issue);
						},
						A2(
							_elm_lang$core$Task$andThen,
							function (_p110) {
							...
							A2(
								...
								_elm_lang$core$Basics$always(
									_elm_lang$core$Task$succeed(
										{ctor: '_Tuple0'})),
								A3(_vito$cadet$GitHubGraph$removeIssueLabel, _p111, issue, 'rejected'))))));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, label) {
		...
		if (_p112.ctor === 'Just') {
			return A2(
				...
				A4(_vito$cadet$GitHubGraph$createRepoLabel, _p112._0.token, repo, label.name, label.color));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, label1, label2) {
		...
		if (_p113.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$LabelChanged(repo),
				A5(_vito$cadet$GitHubGraph$updateRepoLabel, _p113._0.token, repo, label1, label2.name, label2.color));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, label) {
		...
		if (_p114.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$LabelChanged(repo),
				A3(_vito$cadet$GitHubGraph$deleteRepoLabel, _p114._0.token, repo, label.name));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
					...
					},
					{
						...
						_0: A2(
							...
							},
							{
								ctor: '::',
								_0: function () {
									var _p121 = A2(_elm_lang$core$Dict$get, stateKey, model.editingLabels);
												...
												_0: A2(
													_elm_lang$html$Html$span,
													{
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _vito$cadet$Main$labelColorStyle(_p122.color),
																_1: {ctor: '[]'}
															}
														}
													},
												...
												_1: {
													...
													_0: A2(
														_elm_lang$html$Html$input,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$value(_p122.name),
																_1: {
																	ctor: '::',
																	_0: _vito$cadet$Main$labelColorStyle(_p122.color),
																	_1: {ctor: '[]'}
	...
	var labelRows = A3(
		...
		function (_p123) {
			...
			return A3(
				...
				model,
				{name: _p124._0._0, color: _p124._0._1},
				_p124._1);
		});
	var newLabel = A2(
		_elm_lang$html$Html$div,
...
var _vito$cadet$Main$viewCardNodeFlair = F5(
	function (card, radii, flair, _p125, state) {
		var _p126 = _p125;
		var classes = A2(
			_elm_lang$core$Basics_ops['++'],
			{
			...
			function () {
				...
				if (_p127.ctor === 'Nothing') {
					...
					return A3(_vito$cadet$Main$lastActivityIsByUser, state.cardEvents, _p127._0.user.login, card) ? {
						ctor: '::',
			...
			_elm_lang$svg$Svg$g,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$transform(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_p126.x),
							A2(
								_elm_lang$core$Basics_ops['++'],
								', ',
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(_p126.y),
									A2(
										_elm_lang$core$Basics_ops['++'],
										') scale(',
...
var _vito$cadet$Main$viewCardNode = F5(
	function (card, radii, labels, _p128, state) {
		var _p129 = _p128;
		var circleWithNumber = function () {
			var _p130 = card.state;
			if (_p130.ctor === 'IssueState') {
				return {
					ctor: '::',
					_0: A2(
						_elm_lang$svg$Svg$circle,
			...
			_elm_lang$svg$Svg$g,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$transform(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_p129.x),
							A2(
								_elm_lang$core$Basics_ops['++'],
								', ',
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(_p129.y),
									A2(
										_elm_lang$core$Basics_ops['++'],
										') scale(',
										A2(_elm_lang$core$Basics_ops['++'], scale, ')'))))))),
...
var _vito$cadet$Main$cardNode = F3(
	function (allLabels, card, context) {
		...
		return {
			...
			bounds: function (_p131) {
				var _p132 = _p131;
				var _p134 = _p132.y;
				var _p133 = _p132.x;
				return {x1: _p133 - radii.withFlair, y1: _p134 - radii.withFlair, x2: _p133 + radii.withFlair, y2: _p134 + radii.withFlair};
			},
			score: card.score
		};
	});
var _vito$cadet$Main$computeGraph = function (model) {
	var sortFunc = function () {
		var _p135 = model.graphSort;
		if (_p135.ctor === 'ImpactSort') {
			return _vito$cadet$Main$graphSizeCompare;
		} else {
			return _vito$cadet$Main$graphActivityCompare(model);
		}
	}();
	var applyWithContext = function (_p136) {
		var _p137 = _p136;
		var _p138 = _p137.node;
		var context = {incoming: _p137.incoming, outgoing: _p137.outgoing};
		return _elm_lang$core$Native_Utils.update(
			_p137,
			{
				node: _elm_lang$core$Native_Utils.update(
					_p138,
					{
						label: _p138.label(context)
					})
			});
	};
	var allFilters = function () {
		var _p139 = model.baseGraphFilter;
		if (_p139.ctor === 'Just') {
			return {ctor: '::', _0: _p139._0, _1: model.graphFilters};
		} else {
			...
			},
			{
				...
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: function () {
							var _p141 = card.state;
							if (_p141.ctor === 'IssueState') {
								if (_p141._0.ctor === 'IssueStateOpen') {
															...
															_0: function () {
																...
																if (_p142.ctor === 'Just') {
																	...
																	return A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$href(_p143.url),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$target('_blank'),
																				_1: {
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(_p143.login),
																			_1: {ctor: '[]'}
																		});
																} else {
...
var _vito$cadet$Main$moveCard = F3(
	function (model, _p144, cardId) {
		var _p145 = _p144;
		var _p147 = _p145.columnId;
		var _p146 = model.me;
		if (_p146.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$CardMoved(_p147),
				A4(_vito$cadet$GitHubGraph$moveCardAfter, _p146._0.token, _p147, cardId, _p145.afterId));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
var _vito$cadet$Main$addCard = F3(
	function (model, _p148, contentId) {
		var _p149 = _p148;
		var _p154 = _p149.columnId;
		var _p153 = _p149.afterId;
		var _p150 = model.me;
		if (_p150.ctor === 'Just') {
			var _p152 = _p150._0.token;
			var _p151 = A3(_vito$cadet$Main$contentCardId, model, _p149.projectId, contentId);
			if (_p151.ctor === 'Just') {
				return A2(
					_elm_lang$core$Task$attempt,
					_vito$cadet$Main$CardMoved(_p154),
					A4(_vito$cadet$GitHubGraph$moveCardAfter, _p152, _p154, _p151._0, _p153));
			} else {
				return A2(
					_elm_lang$core$Task$attempt,
					_vito$cadet$Main$CardMoved(_p154),
					A4(_vito$cadet$GitHubGraph$addContentCardAfter, _p152, _p154, contentId, _p153));
			}
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
...
var _vito$cadet$Main$viewProjectColumnCard = F4(
	function (model, project, col, ghCard) {
		...
		var _p155 = {ctor: '_Tuple2', _0: ghCard.note, _1: ghCard.contentId};
		_v78_2:
		do {
			if (_p155.ctor === '_Tuple2') {
				if (_p155._0.ctor === 'Just') {
					if (_p155._1.ctor === 'Nothing') {
						return {
							ctor: '::',
							_0: A4(
								_vito$cadet$Drag$draggable,
								...
								dragId,
								A3(_vito$cadet$Main$viewNoteCard, model, col, _p155._0._0)),
							_1: {
								ctor: '::',
								_0: A4(
									_vito$cadet$Drag$viewDropArea,
					...
					if (_p155._1.ctor === 'Just') {
						var _p156 = A2(_elm_lang$core$Dict$get, _p155._1._0, model.allCards);
						if (_p156.ctor === 'Just') {
							return {
								ctor: '::',
								_0: A4(
									...
									_vito$cadet$Main$ProjectDrag,
									dragId,
									A2(_vito$cadet$Main$viewCard, model, _p156._0)),
								_1: {
									ctor: '::',
									_0: A4(
										_vito$cadet$Drag$viewDropArea,
							...
							return _elm_lang$core$Native_Utils.crashCase(
								'Main',
								{
									start: {line: 1711, column: 17},
									end: {line: 1718, column: 70}
								},
								_p156)('impossible: content has no card');
						}
					} else {
						break _v78_2;
					}
		...
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 1704, column: 9},
				end: {line: 1721, column: 41}
			},
			_p155)('impossible');
	});
...
var _vito$cadet$Main$viewSingleProject = F2(
	function (model, _p159) {
		var _p160 = _p159;
		var _p161 = _p160.project;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(_p161.name),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: A4(_vito$cadet$Main$viewProjectColumn, model, _p161, _elm_lang$core$Basics$identity, _p160.inFlight),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						A3(
							...
							function (backlog) {
								return A2(
									...
									{
										ctor: '::',
										_0: A4(_vito$cadet$Main$viewProjectColumn, model, _p161, _elm_lang$core$Basics$identity, backlog),
										_1: {ctor: '[]'}
									});
							}))),
				_1: {
						...
						},
						{
							...
							_1: {
								...
								_0: function () {
									var dropCandidate = {
										msgFunc: _vito$cadet$Main$MoveCardAfter,
										target: {projectId: _p161.id, columnId: _p160.icebox.id, afterId: _elm_lang$core$Maybe$Nothing}
									};
...
var _vito$cadet$Main$viewProjectPage = F2(
	function (model, name) {
		...
		var _p163 = mproject;
		if (_p163.ctor === 'Just') {
			return A2(_vito$cadet$Main$viewSingleProject, model, _p163._0);
		} else {
			...
			_0: A2(
				...
				function (_p164) {
					return _vito$cadet$Main$SetCurrentDate(
						_elm_lang$core$Date$fromTime(_p164));
				}),
			_1: {
				ctor: '::',
			...
			switch (_p165.ctor) {
				...
				case 'SetPage':
					...
					var baseGraphFilter = function () {
						...
						switch (_p166.ctor) {
							...
							case 'ProjectPage':
								return _elm_lang$core$Maybe$Just(
									_vito$cadet$Main$InProjectFilter(_p166._0));
							case 'LabelsPage':
								return _elm_lang$core$Maybe$Just(_vito$cadet$Main$ExcludeAllFilter);
							default:
								return _elm_lang$core$Maybe$Just(_vito$cadet$Main$ExcludeAllFilter);
					...
					return {
						...
						_0: _vito$cadet$Main$computeGraph(
							_vito$cadet$Main$computeDataView(
								_elm_lang$core$Native_Utils.update(
									model,
									{page: _p167, baseGraphFilter: baseGraphFilter}))),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Tick':
					return {
				...
				case 'SetCurrentDate':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{currentDate: _p165._0}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'ProjectDrag':
					var dragModel = A2(_vito$cadet$Drag$update, _p165._0, model.projectDrag);
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{projectDrag: dragModel});
					var _p168 = dragModel;
					if (_p168.ctor === 'Dropped') {
						var _v85 = _p168._0.msg,
							_v86 = newModel;
						msg = _v85;
						model = _v86;
						continue update;
				...
				case 'MilestoneDrag':
					var dragModel = A2(_vito$cadet$Drag$update, _p165._0, model.milestoneDrag);
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{milestoneDrag: dragModel});
					var _p169 = dragModel;
					if (_p169.ctor === 'Dropped') {
						var _v88 = _p169._0.msg,
							_v89 = newModel;
						msg = _v88;
						model = _v89;
						continue update;
				...
				case 'MoveCardAfter':
					var _p171 = _p165._1;
					var _p170 = _p165._0;
					if (_p170.ctor === 'FromColumnCardSource') {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A3(_vito$cadet$Main$moveCard, model, _p171, _p170._0.cardId)
						};
					} else {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A3(_vito$cadet$Main$addCard, model, _p171, _p170._0.contentId)
						};
					}
				case 'CardMoved':
					if (_p165._1.ctor === 'Ok') {
						var _p175 = _p165._0;
						var _p172 = model.projectDrag;
						if (_p172.ctor === 'Dropped') {
							...
							var _p173 = _p172._0.source;
							if (_p173.ctor === 'FromColumnCardSource') {
								var _p174 = _p173._0;
								return _elm_lang$core$Native_Utils.eq(_p174.columnId, _p175) ? A3(refresh, false, _p175, model) : {
									ctor: '_Tuple2',
									_0: model,
									_1: A2(
										_vito$cadet$Backend$refreshCards,
										...
										A2(
											...
											A2(refresh, true, _p174.columnId),
											_p175))
								};
							} else {
								return A3(refresh, false, _p175, model);
							}
						} else {
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						}
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to move card', _p165._1._0),
				...
				case 'CardsFetched':
					if (_p165._2.ctor === 'Ok') {
						...
						var newData = _elm_lang$core$Native_Utils.update(
							data,
							{
								columnCards: A3(_elm_lang$core$Dict$insert, _p165._1, _p165._2._0, data.columnCards)
							});
						return _p165._0(
							_vito$cadet$Main$computeDataView(
								_elm_lang$core$Native_Utils.update(
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to refresh cards', _p165._2._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'SearchCards':
					if (_p165._0 === '') {
						...
						var cardMatch = function (_p176) {
							var _p177 = _p176;
							return A2(
								_elm_lang$core$String$contains,
								_elm_lang$core$String$toLower(_p165._0),
								_elm_lang$core$String$toLower(_p177.title)) ? true : false;
						};
				...
				case 'SelectCard':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								selectedCards: A2(_elm_lang$core$List$member, _p178, model.selectedCards) ? model.selectedCards : A2(
									_elm_lang$core$Basics_ops['++'],
									model.selectedCards,
									{
										ctor: '::',
				...
				case 'HighlightNode':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								highlightedNode: _elm_lang$core$Maybe$Just(_p165._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				...
				case 'AnticipateCardFromNode':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								anticipatedCards: {ctor: '::', _0: _p179, _1: model.anticipatedCards},
								highlightedCard: _elm_lang$core$Maybe$Just(_p179)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				...
				case 'MeFetched':
					if (_p165._0.ctor === 'Ok') {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'error fetching self', _p165._0._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'DataFetched':
					if (_p165._0.ctor === 'Ok') {
						var _p183 = _p165._0._0;
						var allLabels = A3(
							_elm_lang$core$Dict$foldl,
							F3(
								function (_p180, r, ls) {
						...
						return {
							...
							_0: _vito$cadet$Main$computeGraph(
								_vito$cadet$Main$computeDataView(
									_elm_lang$core$Native_Utils.update(
										model,
										{data: _p183, allCards: allCards, allLabels: allLabels}))),
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'error fetching data', _p165._0._0),
							{
								ctor: '_Tuple2',
								_0: model,
								_1: _vito$cadet$Backend$pollData(_vito$cadet$Main$DataFetched)
						...
						F3(
							function (_p184, r, acc) {
								...
								if (_p186.ctor === '[]') {
									return {
										ctor: '::',
										_0: A3(_vito$cadet$Main$createLabel, model, r, _p188),
										_1: acc
									};
								} else {
									var _p187 = _p186._0;
									return _elm_lang$core$Native_Utils.eq(_p187.color, _p188.color) ? acc : {
										ctor: '::',
										_0: A4(_vito$cadet$Main$updateLabel, model, r, _p187, _p188),
										_1: acc
									};
								}
							}),
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								deletingLabels: A2(
									_elm_lang$core$Set$insert,
									_vito$cadet$Main$labelKey(_p165._0),
				...
				case 'DeleteLabel':
					...
					var cmds = A3(
						_elm_lang$core$Dict$foldl,
						F3(
							function (_p189, r, acc) {
								var _p190 = A2(
									_elm_lang$core$List$filter,
									_vito$cadet$Main$matchesLabel(_p191),
									r.labels);
								if (_p190.ctor === '[]') {
									return acc;
								} else {
									return {
										ctor: '::',
										_0: A3(_vito$cadet$Main$deleteLabel, model, r, _p190._0),
										_1: acc
									};
								}
							}),
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								deletingLabels: A2(
									_elm_lang$core$Set$remove,
									_vito$cadet$Main$labelKey(_p191),
									model.deletingLabels)
							}),
						_1: _elm_lang$core$Platform_Cmd$batch(cmds)
					};
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								editingLabels: A3(
									_elm_lang$core$Dict$insert,
									_vito$cadet$Main$labelKey(_p192),
									_p192,
									model.editingLabels)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
				...
				case 'RandomizeLabelColor':
					...
					var _p195 = A2(
						_elm_lang$core$Dict$get,
						_vito$cadet$Main$labelKey(_p196),
						model.editingLabels);
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									editingLabels: A3(
										_elm_lang$core$Dict$insert,
										_vito$cadet$Main$labelKey(_p196),
										_vito$cadet$Main$randomizeColor(_p195._0),
										model.editingLabels)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
							...
							F3(
								function (_p198, r, acc) {
									...
									if (_p199.ctor === '::') {
										return {
											ctor: '::',
											_0: A4(_vito$cadet$Main$updateLabel, model, r, _p199._0, _p197._0),
											_1: acc
										};
									} else {
										return acc;
				...
				case 'CreateLabel':
					if (_elm_lang$core$Native_Utils.eq(model.newLabel.name, '')) {
						...
						var _v99 = _vito$cadet$Main$MirrorLabel(model.newLabel),
				...
				case 'LabelChanged':
					if (_p165._1.ctor === 'Ok') {
						var _p202 = _p165._0;
						var repoSel = {owner: _p202.owner, name: _p202.name};
						return {
							ctor: '_Tuple2',
							_0: model,
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to modify labels', _p165._1._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'RepoRefreshed':
					if (_p165._0.ctor === 'Ok') {
						var _p203 = _p165._0._0;
						var data = model.data;
						return {
							ctor: '_Tuple2',
								...
								_elm_lang$core$Native_Utils.update(
									model,
									{
										data: _elm_lang$core$Native_Utils.update(
											data,
											{
												repos: A3(_elm_lang$core$Dict$insert, _p203.id, _p203, data.repos)
											}),
										allLabels: A3(
											_elm_lang$core$List$foldl,
											function (l) {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to refresh repo', _p165._0._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'AcceptCard':
					var _p204 = _p165._0.content;
					if (_p204.ctor === 'IssueCardContent') {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A2(_vito$cadet$Main$acceptIssue, model, _p204._0)
						};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				case 'CardAccepted':
					if (_p165._1.ctor === 'Ok') {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to accept card', _p165._1._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'RejectCard':
					var _p205 = _p165._0.content;
					if (_p205.ctor === 'IssueCardContent') {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A2(_vito$cadet$Main$rejectIssue, model, _p205._0)
						};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				case 'CardRejected':
					if (_p165._1.ctor === 'Ok') {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to reject card', _p165._1._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
						...
						F3(
							function (_p206, r, acc) {
								return A2(
									...
									r.milestones) ? acc : {
									ctor: '::',
									_0: A3(_vito$cadet$Main$createMilestone, model, r, _p208),
									_1: acc
								};
							}),
						{ctor: '[]'},
						...
						F3(
							function (_p209, r, acc) {
								...
								if (_p211.ctor === '::') {
									return {
										ctor: '::',
										_0: A3(_vito$cadet$Main$closeMilestone, model, r, _p211._0),
										_1: acc
									};
								} else {
									return acc;
						...
						F3(
							function (_p212, r, acc) {
								...
								if (_p214.ctor === '::') {
									return {
										ctor: '::',
										_0: A3(_vito$cadet$Main$deleteMilestone, model, r, _p214._0),
										_1: acc
									};
								} else {
									return acc;
				...
				case 'MilestoneChanged':
					if (_p165._1.ctor === 'Ok') {
						var _p215 = _p165._0;
						var repoSel = {owner: _p215.owner, name: _p215.name};
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A2(_vito$cadet$Backend$refreshRepo, repoSel, _vito$cadet$Main$RepoRefreshed)
				...
				case 'SetNewMilestoneName':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{newMilestoneName: _p165._0}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'CreateMilestone':
					var _p216 = model.newMilestoneName;
					if (_p216 === '') {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					} else {
						var _v106 = _vito$cadet$Main$MirrorMilestone(_p216),
							_v107 = model;
						msg = _v106;
						model = _v107;
						continue update;
				...
				case 'SetCardMilestone':
					var _p222 = _p165._0;
					var set = function () {
						var _p217 = _p222.content;
						if (_p217.ctor === 'IssueCardContent') {
							return A2(_vito$cadet$Main$setIssueMilestone, model, _p217._0);
						} else {
							return A2(_vito$cadet$Main$setPRMilestone, model, _p217._0);
						}
					}();
					var _p218 = _p165._1;
					if (_p218.ctor === 'Nothing') {
						return {
							ctor: '_Tuple2',
							_0: model,
						...
						var _p219 = A2(_elm_lang$core$Dict$get, _p222.repo.id, model.data.repos);
						if (_p219.ctor === 'Just') {
							var _p221 = A2(
								_elm_lang$core$List$filter,
								function (_p220) {
							...
							if (_p221.ctor === '::') {
								return {
									...
									_0: model,
									_1: set(
										_elm_lang$core$Maybe$Just(_p221._0))
								};
							} else {
								return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
							}
				...
				case 'IssueMilestoneChanged':
					if (_p165._1.ctor === 'Ok') {
						return {
							...
							_1: A2(_vito$cadet$Backend$refreshIssue, _p165._0.id, _vito$cadet$Main$IssueRefreshed)
						};
					} else {
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to change milestone', _p165._1._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'IssueRefreshed':
					if (_p165._0.ctor === 'Ok') {
						var _p223 = _p165._0._0;
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									...
									allCards: A3(
										_elm_lang$core$Dict$insert,
										_p223.id,
										_vito$cadet$Main$issueCard(_p223),
										model.allCards)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to refresh issue', _p165._0._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'PRMilestoneChanged':
					if (_p165._1.ctor === 'Ok') {
						return {
							...
							_1: A2(_vito$cadet$Backend$refreshPR, _p165._0.id, _vito$cadet$Main$PRRefreshed)
						};
					} else {
						return A3(
							_elm_lang$core$Basics$flip,
				...
				case 'PRRefreshed':
					if (_p165._0.ctor === 'Ok') {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to refresh pr', _p165._0._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'AddFilter':
					return {
						...
						_0: _vito$cadet$Main$computeGraph(
							_elm_lang$core$Native_Utils.update(
								model,
								{
									graphFilters: {ctor: '::', _0: _p165._0, _1: model.graphFilters}
								})),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'RemoveFilter':
...
var _vito$cadet$Main$viewProject = F2(
	function (model, _p225) {
		var _p226 = _p225;
		var _p227 = _p226.project;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
										...
										_0: A2(
											_elm_lang$html$Html$a,
											{
												...
												_0: _elm_lang$html$Html_Attributes$href(
													A2(_elm_lang$core$Basics_ops['++'], '/projects/', _p227.name)),
												_1: {
													ctor: '::',
													_0: _vito$cadet$StrictEvents$onLeftClick(
														_vito$cadet$Main$SetPage(
															_vito$cadet$Main$ProjectPage(_p227.name))),
													_1: {ctor: '[]'}
												}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(_p227.name),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: A4(_vito$cadet$Main$viewProjectColumn, model, _p227, _elm_lang$core$Basics$identity, _p226.inFlight),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
	...
	var page = function () {
		...
		do {
			if (_p228.ctor === '[]') {
				...
				if (_p228._1.ctor === '::') {
					if ((_p228._0 === 'projects') && (_p228._1._1.ctor === '[]')) {
						return _vito$cadet$Main$SetPage(
							_vito$cadet$Main$ProjectPage(_p228._1._0));
					} else {
						break _v113_5;
					}
				} else {
						...
						if (_p229.ctor === 'Nothing') {
							...
							return A2(
								_elm_lang$html$Html$a,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href(_p230.url),
										_1: {ctor: '[]'}
									}
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$img,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$src(_p230.avatar),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(_p230.login),
										_1: {ctor: '[]'}
									}
								});
						}
	...
	var anticipatedCards = A2(
		...
		A2(
			...
			A2(
				_elm_lang$core$List$filter,
				function (_p231) {
					return !A3(_elm_lang$core$Basics$flip, _elm_lang$core$List$member, model.selectedCards, _p231);
				},
				model.anticipatedCards)));
						...
						},
						{
							...
							_0: function () {
								...
								switch (_p232.ctor) {
									...
									case 'ProjectPage':
										return A2(_vito$cadet$Main$viewProjectPage, model, _p232._0);
									case 'LabelsPage':
