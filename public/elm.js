			...
			while (true) {
				...
				if (_p7.ctor === '[]') {
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							start: {line: 2558, column: 25},
							end: {line: 2572, column: 57}
						},
						_p8)('impossible');
				}
			}
	...
	if ((((((((_p14.ctor === 'Just') && (_p14._0.ctor === '::')) && (_p14._0._0.ctor === 'Just')) && (_p14._0._1.ctor === '::')) && (_p14._0._1._0.ctor === 'Just')) && (_p14._0._1._1.ctor === '::')) && (_p14._0._1._1._0.ctor === 'Just')) && (_p14._0._1._1._1.ctor === '[]')) {
		...
		if (((((((_p15.ctor === '::') && (_p15._0.ctor === 'Ok')) && (_p15._1.ctor === '::')) && (_p15._1._0.ctor === 'Ok')) && (_p15._1._1.ctor === '::')) && (_p15._1._1._0.ctor === 'Ok')) && (_p15._1._1._1.ctor === '[]')) {
			...
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 2476, column: 17},
					end: {line: 2484, column: 50}
				},
				_p15)('invalid hex');
		}
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 2474, column: 9},
				end: {line: 2487, column: 42}
			},
			_p14)('invalid hex');
	}
};
...
var _vito$cadet$Main$needsAcceptance = F2(
	function (model, card) {
		return (A2(_vito$cadet$Main$isEnhancement, model, card) || A2(_vito$cadet$Main$isBug, model, card)) && (!A2(_vito$cadet$Main$isWontfix, model, card));
	});
			...
			_elm_lang$html$Html$img,
			{
				...
				_0: _elm_lang$html$Html_Attributes$class(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'card-actor ',
						A2(_vito$cadet$Main$activityClass, model.currentDate, _p27.createdAt))),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$src(
						A2(_elm_lang$core$Basics_ops['++'], _p27.actor.avatar, '&s=88')),
					_1: {
						ctor: '::',
...
var _vito$cadet$Main$issueRadius = F2(
	function (card, _p28) {
		...
		return 15 + ((_elm_lang$core$Basics$toFloat(
			_elm_community$intdict$IntDict$size(_p29.incoming)) / 2) + _elm_lang$core$Basics$toFloat(
			_elm_community$intdict$IntDict$size(_p29.outgoing) * 2));
	});
	...
	function (card, context) {
		...
		var emojiReactions = A3(
			...
			function (_p31) {
				...
				return {
					ctor: '_Tuple2',
					_0: reactionTypeEmoji(_p32.type_),
					_1: _p32.count
				};
			});
		var flairs = A2(
			...
			function (i, _p34) {
				...
				var segments = A2(
					_gampleman$elm_visualization$Visualization_Shape$pie,
					{
						...
						innerRadius: radius,
						outerRadius: (radius + _vito$cadet$Main$flairRadiusBase) + _elm_lang$core$Basics$toFloat(_p35._1),
						cornerRadius: 3,
						padRadius: 0
					},
					A2(
				...
				if ((_p38.ctor === '::') && (_p38._1.ctor === '[]')) {
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							start: {line: 1980, column: 17},
							end: {line: 1985, column: 49}
						},
						_p38)('impossible');
				}
			});
		return A3(
			...
			F2(
				function (i, _p40) {
					var _p41 = _p40;
					var arc = A2(reactionSegment, i, _p41);
					return A2(
						_elm_lang$svg$Svg$g,
						{
							ctor: '::',
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$svg$Svg$text(_p41._0),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _vito$cadet$Main$linkPath = F2(
	function (graph, edge) {
		var target = function () {
			...
			if (_p45.ctor === 'Just') {
				return {x: _p45._0.x, y: _p45._0.y};
			} else {
				return {x: 0, y: 0};
			}
		}();
...
var _vito$cadet$Main$viewNodeLowerUpper = F3(
	function (state, _p49, _p48) {
		var _p50 = _p49;
		var _p52 = _p50.node;
		var _p51 = _p48;
		var pos = {x: _p52.label.x, y: _p52.label.y};
		return {
			ctor: '_Tuple2',
			_0: {
				ctor: '::',
				_0: A3(_elm_lang$svg$Svg_Lazy$lazy2, _p52.label.value.viewLower, pos, state),
				_1: _p51._0
			},
			_1: {
				ctor: '::',
				_0: A3(_elm_lang$svg$Svg_Lazy$lazy2, _p52.label.value.viewUpper, pos, state),
				_1: _p51._1
			}
		};
	});
	...
	function (model, _p53) {
		...
		var links = A2(
			...
			_elm_lang$svg$Svg_Lazy$lazy(
				_vito$cadet$Main$linkPath(_p64)),
			_elm_community$graph$Graph$edges(_p64));
		var padding = 10;
		var nodeContexts = A3(
			_elm_community$graph$Graph$fold,
			F2(
		...
		var minX = A3(
			...
			F2(
				function (_p56, acc) {
					var _p57 = _p56;
					return A2(_elm_lang$core$Basics$min, _p57.x1, acc);
				}),
			999999,
			bounds) - padding;
		var minY = A3(
			...
			F2(
				function (_p58, acc) {
					var _p59 = _p58;
					return A2(_elm_lang$core$Basics$min, _p59.y1, acc);
				}),
			999999,
			bounds) - padding;
		var maxX = A3(
			...
			F2(
				function (_p60, acc) {
					var _p61 = _p60;
					return A2(_elm_lang$core$Basics$max, _p61.x2, acc);
				}),
			0,
			bounds) + padding;
		var width = maxX - minX;
		var maxY = A3(
			...
			F2(
				function (_p62, acc) {
					var _p63 = _p62;
					return A2(_elm_lang$core$Basics$max, _p63.y2, acc);
				}),
			0,
			bounds) + padding;
			...
			var graphScore = function (_p66) {
				return A3(
					...
					A2(
						...
						_elm_community$graph$Graph$nodes(_p66)));
			};
			return A2(
				_elm_lang$core$Basics$compare,
				graphScore(a.graph),
...
var _vito$cadet$Main$onlyAcceptableCards = function (model) {
	return _elm_lang$core$List$filter(
		function (_p68) {
			var _p69 = _p68;
			var _p70 = _p69.contentId;
			if (_p70.ctor === 'Just') {
				var _p71 = A2(_elm_lang$core$Dict$get, _p70._0, model.allCards);
				if (_p71.ctor === 'Just') {
					var _p72 = _p71._0;
					return _vito$cadet$Main$isOpen(_p72) || (A2(_vito$cadet$Main$needsAcceptance, model, _p72) && (!A2(_vito$cadet$Main$isAccepted, model, _p72)));
				} else {
					return false;
				}
			} else {
...
var _vito$cadet$Main$includesLabel = F3(
	function (model, label, labelIds) {
		return A2(
			_elm_lang$core$List$any,
			function (id) {
				var _p73 = A2(_elm_lang$core$Dict$get, id, model.allLabels);
				if (_p73.ctor === 'Just') {
					return A2(_vito$cadet$Main$matchesLabel, label, _p73._0);
				} else {
					return false;
				}
			},
...
var _vito$cadet$Main$selectStatefulProject = function (project) {
	...
	var _p76 = {ctor: '_Tuple4', _0: icebox, _1: backlogs, _2: inFlights, _3: dones};
	if ((((((((_p76.ctor === '_Tuple4') && (_p76._0.ctor === '::')) && (_p76._0._1.ctor === '[]')) && (_p76._1.ctor === '::')) && (_p76._2.ctor === '::')) && (_p76._2._1.ctor === '[]')) && (_p76._3.ctor === '::')) && (_p76._3._1.ctor === '[]')) {
		return _elm_lang$core$Maybe$Just(
			{project: project, icebox: _p76._0._0, backlogs: _p76._1, inFlight: _p76._2._0, done: _p76._3._0});
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
																...
																return function (q) {
																	return function (r) {
																		return function (s) {
																			return function (t) {
																				return function (u) {
																					return {config: a, me: b, page: c, currentDate: d, projectDrag: e, milestoneDrag: f, data: g, dataView: h, allCards: i, allLabels: j, selectedCards: k, anticipatedCards: l, highlightedCard: m, highlightedNode: n, cardGraphs: o, computeGraph: p, deletingLabels: q, editingLabels: r, newLabel: s, newLabelColored: t, newMilestoneName: u};
																				};
																			};
																		};
																	};
...
var _vito$cadet$Main$prCard = function (_p77) {
	var _p78 = _p77;
	var _p79 = _p78;
	return {
		id: _p78.id,
		content: _vito$cadet$GitHubGraph$PullRequestCardContent(_p79),
		url: _p78.url,
		repo: _p78.repo,
		number: _p78.number,
		title: _p78.title,
		updatedAt: _p78.updatedAt,
		author: _p78.author,
		labels: A2(
			_elm_lang$core$List$map,
			function (_) {
			...
			_p78.labels),
		cards: _p78.cards,
		commentCount: _p78.commentCount,
		reactions: _p78.reactions,
		score: _vito$cadet$GitHubGraph$pullRequestScore(_p79),
		state: _vito$cadet$Main$PullRequestState(_p78.state),
		milestone: _p78.milestone
	};
};
	...
	switch (_p81.ctor) {
		case 'MilestonesPage':
			...
			var cardsByMilestone = A3(
				_elm_lang$core$Dict$foldl,
				F3(
					function (_p83, card, acc) {
						var _p84 = card.milestone;
						if (_p84.ctor === 'Just') {
							return A3(
								_elm_lang$core$Dict$update,
								_p84._0.title,
...
var _vito$cadet$Main$issueCard = function (_p88) {
	var _p89 = _p88;
	var _p90 = _p89;
	return {
		id: _p89.id,
		content: _vito$cadet$GitHubGraph$IssueCardContent(_p90),
		url: _p89.url,
		repo: _p89.repo,
		number: _p89.number,
		title: _p89.title,
		updatedAt: _p89.updatedAt,
		author: _p89.author,
		labels: A2(
			_elm_lang$core$List$map,
			function (_) {
			...
			_p89.labels),
		cards: _p89.cards,
		commentCount: _p89.commentCount,
		reactions: _p89.reactions,
		score: _vito$cadet$GitHubGraph$issueScore(_p90),
		state: _vito$cadet$Main$IssueState(_p89.state),
		milestone: _p89.milestone
	};
};
	...
	function (model, pr, mmilestone) {
		...
		if (_p91.ctor === 'Just') {
			return A2(
				...
				A3(_vito$cadet$GitHubGraph$setPullRequestMilestone, _p91._0.token, pr, mmilestone));
		} else {
	...
	function (model, issue, mmilestone) {
		...
		if (_p92.ctor === 'Just') {
			return A2(
				...
				A3(_vito$cadet$GitHubGraph$setIssueMilestone, _p92._0.token, issue, mmilestone));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, title) {
		...
		if (_p93.ctor === 'Just') {
			return A2(
				...
				A3(_vito$cadet$GitHubGraph$createRepoMilestone, _p93._0.token, repo, title));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, milestone) {
		...
		if (_p94.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$MilestoneChanged(repo),
				A3(_vito$cadet$GitHubGraph$closeRepoMilestone, _p94._0.token, repo, milestone));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, milestone) {
		...
		if (_p95.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$MilestoneChanged(repo),
				A3(_vito$cadet$GitHubGraph$deleteRepoMilestone, _p95._0.token, repo, milestone));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
...
var _vito$cadet$Main$rejectIssue = F2(
	function (model, issue) {
		...
		if (_p96.ctor === 'Just') {
			...
			var moveCardToBacklog = function (card) {
				var _p97 = A2(_elm_lang$core$Dict$get, card.project.id, model.data.projects);
				if (_p97.ctor === 'Just') {
					var _p99 = A2(
						_elm_lang$core$List$filter,
						function (_p98) {
					...
					if ((_p99.ctor === '::') && (_p99._1.ctor === '[]')) {
						return _elm_lang$core$Maybe$Just(
							{ctor: '_Tuple2', _0: _p99._0.id, _1: card.id});
					} else {
						return _elm_lang$core$Maybe$Nothing;
					}
				} else {
			...
			var cardsToMove = A2(_elm_lang$core$List$filterMap, moveCardToBacklog, issue.cards);
				...
				A2(
					...
					_elm_lang$core$Set$fromList(
						A2(
							...
							issue.cards)),
					_elm_lang$core$Set$fromList(
						A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$first, cardsToMove))));
			var moves = A2(
				_elm_lang$core$List$map,
				function (_p101) {
					var _p102 = _p101;
					return A2(
						...
						A2(
							_elm_lang$core$Task$mapError,
							_elm_lang$core$Basics$toString,
							A4(_vito$cadet$GitHubGraph$moveCardAfter, _p103, _p102._0, _p102._1, _elm_lang$core$Maybe$Nothing)));
				},
				cardsToMove);
			return A2(
				_elm_lang$core$Task$attempt,
			...
			return A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$Task$andThen,
						function (_p106) {
							return A2(_vito$cadet$GitHubGraph$closeIssue, _p108, issue);
						},
						A2(
							_elm_lang$core$Task$andThen,
							function (_p107) {
							...
							A2(
								...
								_elm_lang$core$Basics$always(
									_elm_lang$core$Task$succeed(
										{ctor: '_Tuple0'})),
								A3(_vito$cadet$GitHubGraph$removeIssueLabel, _p108, issue, 'rejected'))))));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, label) {
		...
		if (_p109.ctor === 'Just') {
			return A2(
				...
				A4(_vito$cadet$GitHubGraph$createRepoLabel, _p109._0.token, repo, label.name, label.color));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, label1, label2) {
		...
		if (_p110.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$LabelChanged(repo),
				A5(_vito$cadet$GitHubGraph$updateRepoLabel, _p110._0.token, repo, label1, label2.name, label2.color));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, label) {
		...
		if (_p111.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$LabelChanged(repo),
				A3(_vito$cadet$GitHubGraph$deleteRepoLabel, _p111._0.token, repo, label.name));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
					...
					},
					{
						...
						_0: A2(
							...
							},
							{
								ctor: '::',
								_0: function () {
									var _p118 = A2(_elm_lang$core$Dict$get, stateKey, model.editingLabels);
												...
												_0: A2(
													_elm_lang$html$Html$span,
													{
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _vito$cadet$Main$labelColorStyle(_p119.color),
																_1: {ctor: '[]'}
															}
														}
													},
												...
												_1: {
													...
													_0: A2(
														_elm_lang$html$Html$input,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$value(_p119.name),
																_1: {
																	ctor: '::',
																	_0: _vito$cadet$Main$labelColorStyle(_p119.color),
																	_1: {ctor: '[]'}
	...
	var labelRows = A3(
		...
		function (_p120) {
			...
			return A3(
				...
				model,
				{name: _p121._0._0, color: _p121._0._1},
				_p121._1);
		});
	var newLabel = A2(
		_elm_lang$html$Html$div,
...
var _vito$cadet$Main$viewCardNodeFlair = F5(
	function (card, radii, flair, _p122, state) {
		var _p123 = _p122;
		var projectHalo = A2(
			...
			_elm_lang$svg$Svg$g,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$transform(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_p123.x),
							A2(
								_elm_lang$core$Basics_ops['++'],
								', ',
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(_p123.y),
									A2(
										_elm_lang$core$Basics_ops['++'],
										') scale(',
...
var _vito$cadet$Main$viewCardNode = F5(
	function (card, radii, labels, _p124, state) {
		var _p125 = _p124;
		var circleWithNumber = function () {
			var _p126 = card.state;
			if (_p126.ctor === 'IssueState') {
				return {
					ctor: '::',
					_0: A2(
						_elm_lang$svg$Svg$circle,
			...
			_elm_lang$svg$Svg$g,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$transform(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_p125.x),
							A2(
								_elm_lang$core$Basics_ops['++'],
								', ',
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(_p125.y),
									A2(
										_elm_lang$core$Basics_ops['++'],
										') scale(',
										A2(_elm_lang$core$Basics_ops['++'], scale, ')'))))))),
...
var _vito$cadet$Main$cardNode = F3(
	function (allLabels, card, context) {
		...
		return {
			...
			bounds: function (_p127) {
				var _p128 = _p127;
				var _p130 = _p128.y;
				var _p129 = _p128.x;
				return {x1: _p129 - radii.withFlair, y1: _p130 - radii.withFlair, x2: _p129 + radii.withFlair, y2: _p130 + radii.withFlair};
			},
			score: card.score
		};
	});
var _vito$cadet$Main$computeReferenceGraph = F2(
	function (data, allCards) {
		var applyWithContext = function (_p131) {
			var _p132 = _p131;
			var _p133 = _p132.node;
			var context = {incoming: _p132.incoming, outgoing: _p132.outgoing};
			return _elm_lang$core$Native_Utils.update(
				_p132,
				{
					node: _elm_lang$core$Native_Utils.update(
		...
		var cardNodeThunks = A3(
			_elm_lang$core$Dict$foldl,
			F3(
				function (_p135, card, thunks) {
					return _vito$cadet$Main$isOpen(card) ? {
						ctor: '::',
						_0: A2(
							_elm_community$graph$Graph$Node,
							_vito$cadet$Hash$hash(card.id),
							A2(_vito$cadet$Main$cardNode, allLabels, card)),
						_1: thunks
					} : thunks;
				}),
			{ctor: '[]'},
					...
					},
					{
						...
						_0: function () {
							...
							if (_p136.ctor === 'IssueState') {
								if (_p136._0.ctor === 'IssueStateOpen') {
									return A2(
										_elm_lang$html$Html$span,
										{
											ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_0: (A2(_vito$cadet$Main$needsAcceptance, model, card) && _vito$cadet$Main$isDone(card)) ? A2(
									...
									{ctor: '[]'}) : (A2(_vito$cadet$Main$isRejected, model, card) ? A2(
									_elm_lang$html$Html$span,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('octicon rejected octicon-thumbsdown'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_vito$cadet$Main$RejectCard(card)),
															...
															_0: function () {
																...
																if (_p137.ctor === 'Just') {
																	...
																	return A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$href(_p138.url),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$target('_blank'),
																				_1: {
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(_p138.login),
																			_1: {ctor: '[]'}
																		});
																} else {
...
var _vito$cadet$Main$moveCard = F3(
	function (model, _p139, cardId) {
		var _p140 = _p139;
		var _p142 = _p140.columnId;
		var _p141 = model.me;
		if (_p141.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$CardMoved(_p142),
				A4(_vito$cadet$GitHubGraph$moveCardAfter, _p141._0.token, _p142, cardId, _p140.afterId));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
var _vito$cadet$Main$addCard = F3(
	function (model, _p143, contentId) {
		var _p144 = _p143;
		var _p149 = _p144.columnId;
		var _p148 = _p144.afterId;
		var _p145 = model.me;
		if (_p145.ctor === 'Just') {
			var _p147 = _p145._0.token;
			var _p146 = A3(_vito$cadet$Main$contentCardId, model, _p144.projectId, contentId);
			if (_p146.ctor === 'Just') {
				return A2(
					_elm_lang$core$Task$attempt,
					_vito$cadet$Main$CardMoved(_p149),
					A4(_vito$cadet$GitHubGraph$moveCardAfter, _p147, _p149, _p146._0, _p148));
			} else {
				return A2(
					_elm_lang$core$Task$attempt,
					_vito$cadet$Main$CardMoved(_p149),
					A4(_vito$cadet$GitHubGraph$addContentCardAfter, _p147, _p149, contentId, _p148));
			}
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
...
var _vito$cadet$Main$viewProjectColumnCard = F4(
	function (model, project, col, ghCard) {
		...
		var _p150 = {ctor: '_Tuple2', _0: ghCard.note, _1: ghCard.contentId};
		_v74_2:
		do {
			if (_p150.ctor === '_Tuple2') {
				if (_p150._0.ctor === 'Just') {
					if (_p150._1.ctor === 'Nothing') {
						return {
							ctor: '::',
							_0: A4(
								_vito$cadet$Drag$draggable,
								...
								dragId,
								A3(_vito$cadet$Main$viewNoteCard, model, col, _p150._0._0)),
							_1: {
								ctor: '::',
								_0: A4(
									_vito$cadet$Drag$viewDropArea,
					...
					if (_p150._1.ctor === 'Just') {
						var _p151 = A2(_elm_lang$core$Dict$get, _p150._1._0, model.allCards);
						if (_p151.ctor === 'Just') {
							return {
								ctor: '::',
								_0: A4(
									...
									_vito$cadet$Main$ProjectDrag,
									dragId,
									A2(_vito$cadet$Main$viewCard, model, _p151._0)),
								_1: {
									ctor: '::',
									_0: A4(
										_vito$cadet$Drag$viewDropArea,
							...
							return _elm_lang$core$Native_Utils.crashCase(
								'Main',
								{
									start: {line: 1619, column: 17},
									end: {line: 1626, column: 70}
								},
								_p151)('impossible: content has no card');
						}
					} else {
						break _v74_2;
					}
		...
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 1612, column: 9},
				end: {line: 1629, column: 41}
			},
			_p150)('impossible');
	});
...
var _vito$cadet$Main$viewSingleProject = F2(
	function (model, _p154) {
		var _p155 = _p154;
		var _p156 = _p155.project;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(_p156.name),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: A4(_vito$cadet$Main$viewProjectColumn, model, _p156, _elm_lang$core$Basics$identity, _p155.inFlight),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						A3(
							...
							function (backlog) {
								return A2(
									...
									{
										ctor: '::',
										_0: A4(_vito$cadet$Main$viewProjectColumn, model, _p156, _elm_lang$core$Basics$identity, backlog),
										_1: {ctor: '[]'}
									});
							}))),
				_1: {
						...
						},
						{
							...
							_1: {
								...
								_0: function () {
									var dropCandidate = {
										msgFunc: _vito$cadet$Main$MoveCardAfter,
										target: {projectId: _p156.id, columnId: _p155.icebox.id, afterId: _elm_lang$core$Maybe$Nothing}
									};
...
var _vito$cadet$Main$viewProjectPage = F2(
	function (model, name) {
		...
		var _p158 = mproject;
		if (_p158.ctor === 'Just') {
			return A2(_vito$cadet$Main$viewSingleProject, model, _p158._0);
		} else {
			...
			_0: A2(
				...
				function (_p159) {
					return _vito$cadet$Main$SetCurrentDate(
						_elm_lang$core$Date$fromTime(_p159));
				}),
			_1: {
				ctor: '::',
			...
			switch (_p160.ctor) {
								...
								case 'ProjectPage':
									return A2(
										...
										A2(
											_elm_lang$core$Dict$filter,
											function (_p162) {
												return _vito$cadet$Main$isInProject(_p161._0);
											},
											cards));
								case 'LabelsPage':
									return {ctor: '[]'};
					...
					return {
						...
						_0: _vito$cadet$Main$computeDataView(
							_elm_lang$core$Native_Utils.update(
								...
								{
									page: _p163,
									cardGraphs: A2(compute, model.data, model.allCards),
				...
				case 'SetCurrentDate':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{currentDate: _p160._0}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'ProjectDrag':
					var dragModel = A2(_vito$cadet$Drag$update, _p160._0, model.projectDrag);
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{projectDrag: dragModel});
					var _p164 = dragModel;
					if (_p164.ctor === 'Dropped') {
						var _v81 = _p164._0.msg,
							_v82 = newModel;
						msg = _v81;
						model = _v82;
						continue update;
				...
				case 'MilestoneDrag':
					var dragModel = A2(_vito$cadet$Drag$update, _p160._0, model.milestoneDrag);
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{milestoneDrag: dragModel});
					var _p165 = dragModel;
					if (_p165.ctor === 'Dropped') {
						var _v84 = _p165._0.msg,
							_v85 = newModel;
						msg = _v84;
						model = _v85;
						continue update;
				...
				case 'MoveCardAfter':
					var _p167 = _p160._1;
					var _p166 = _p160._0;
					if (_p166.ctor === 'FromColumnCardSource') {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A3(_vito$cadet$Main$moveCard, model, _p167, _p166._0.cardId)
						};
					} else {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A3(_vito$cadet$Main$addCard, model, _p167, _p166._0.contentId)
						};
					}
				case 'CardMoved':
					if (_p160._1.ctor === 'Ok') {
						var _p171 = _p160._0;
						var _p168 = model.projectDrag;
						if (_p168.ctor === 'Dropped') {
								...
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											...
											cardGraphs: A2(model.computeGraph, model.data, model.allCards)
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							};
							...
							var _p169 = _p168._0.source;
							if (_p169.ctor === 'FromColumnCardSource') {
								var _p170 = _p169._0;
								return _elm_lang$core$Native_Utils.eq(_p170.columnId, _p171) ? A3(refresh, false, _p171, model) : {
									ctor: '_Tuple2',
									_0: model,
									_1: A2(
										_vito$cadet$Backend$refreshCards,
										...
										A2(
											...
											A2(refresh, true, _p170.columnId),
											_p171))
								};
							} else {
								return A3(refresh, false, _p171, model);
							}
						} else {
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						}
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to move card', _p160._1._0),
				...
				case 'CardsFetched':
					if (_p160._2.ctor === 'Ok') {
						...
						var newData = _elm_lang$core$Native_Utils.update(
							data,
							{
								columnCards: A3(_elm_lang$core$Dict$insert, _p160._1, _p160._2._0, data.columnCards)
							});
						return _p160._0(
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to refresh cards', _p160._2._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'SearchCards':
					if (_p160._0 === '') {
						...
						var cardMatch = function (_p172) {
							var _p173 = _p172;
							return A2(
								_elm_lang$core$String$contains,
								_elm_lang$core$String$toLower(_p160._0),
								_elm_lang$core$String$toLower(_p173.title)) ? true : false;
						};
				...
				case 'SelectCard':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								selectedCards: A2(_elm_lang$core$List$member, _p174, model.selectedCards) ? model.selectedCards : A2(
									_elm_lang$core$Basics_ops['++'],
									model.selectedCards,
									{
										ctor: '::',
				...
				case 'HighlightNode':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								highlightedNode: _elm_lang$core$Maybe$Just(_p160._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				...
				case 'AnticipateCardFromNode':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								anticipatedCards: {ctor: '::', _0: _p175, _1: model.anticipatedCards},
								highlightedCard: _elm_lang$core$Maybe$Just(_p175)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				...
				case 'MeFetched':
					if (_p160._0.ctor === 'Ok') {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'error fetching self', _p160._0._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'DataFetched':
					if (_p160._0.ctor === 'Ok') {
						var _p179 = _p160._0._0;
						var allLabels = A3(
							_elm_lang$core$Dict$foldl,
							F3(
								function (_p176, r, ls) {
							...
							_0: _vito$cadet$Main$computeDataView(
								_elm_lang$core$Native_Utils.update(
									model,
									{
										...
										allCards: allCards,
										allLabels: allLabels,
										cardGraphs: A2(model.computeGraph, _p179, allCards)
									})),
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'error fetching data', _p160._0._0),
							{
								ctor: '_Tuple2',
								_0: model,
								_1: _vito$cadet$Backend$pollData(_vito$cadet$Main$DataFetched)
						...
						F3(
							function (_p180, r, acc) {
								...
								if (_p182.ctor === '[]') {
									return {
										ctor: '::',
										_0: A3(_vito$cadet$Main$createLabel, model, r, _p184),
										_1: acc
									};
								} else {
									var _p183 = _p182._0;
									return _elm_lang$core$Native_Utils.eq(_p183.color, _p184.color) ? acc : {
										ctor: '::',
										_0: A4(_vito$cadet$Main$updateLabel, model, r, _p183, _p184),
										_1: acc
									};
								}
							}),
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								deletingLabels: A2(
									_elm_lang$core$Set$insert,
									_vito$cadet$Main$labelKey(_p160._0),
				...
				case 'DeleteLabel':
					...
					var cmds = A3(
						_elm_lang$core$Dict$foldl,
						F3(
							function (_p185, r, acc) {
								var _p186 = A2(
									_elm_lang$core$List$filter,
									_vito$cadet$Main$matchesLabel(_p187),
									r.labels);
								if (_p186.ctor === '[]') {
									return acc;
								} else {
									return {
										ctor: '::',
										_0: A3(_vito$cadet$Main$deleteLabel, model, r, _p186._0),
										_1: acc
									};
								}
							}),
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								deletingLabels: A2(
									_elm_lang$core$Set$remove,
									_vito$cadet$Main$labelKey(_p187),
									model.deletingLabels)
							}),
						_1: _elm_lang$core$Platform_Cmd$batch(cmds)
					};
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								editingLabels: A3(
									_elm_lang$core$Dict$insert,
									_vito$cadet$Main$labelKey(_p188),
									_p188,
									model.editingLabels)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									editingLabels: A3(
										_elm_lang$core$Dict$insert,
										_vito$cadet$Main$labelKey(_p192),
										_vito$cadet$Main$randomizeColor(_p191._0),
										model.editingLabels)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
				...
				case 'EditLabel':
					...
					if (_p193.ctor === 'Nothing') {
						...
						var cmds = A3(
							_elm_lang$core$Dict$foldl,
							F3(
								function (_p194, r, acc) {
									var _p195 = A2(
										_elm_lang$core$List$filter,
										_vito$cadet$Main$matchesLabel(_p196),
										r.labels);
									if (_p195.ctor === '::') {
										return {
											ctor: '::',
											_0: A4(_vito$cadet$Main$updateLabel, model, r, _p195._0, _p193._0),
											_1: acc
										};
									} else {
										return acc;
				...
				case 'CreateLabel':
					if (_elm_lang$core$Native_Utils.eq(model.newLabel.name, '')) {
						...
						var _v95 = _vito$cadet$Main$MirrorLabel(model.newLabel),
							_v96 = _elm_lang$core$Native_Utils.update(
							model,
							{
				...
				case 'LabelChanged':
					if (_p160._1.ctor === 'Ok') {
						var _p198 = _p160._0;
						var repoSel = {owner: _p198.owner, name: _p198.name};
						return {
							ctor: '_Tuple2',
							_0: model,
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to modify labels', _p160._1._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'RepoRefreshed':
					if (_p160._0.ctor === 'Ok') {
						var _p199 = _p160._0._0;
						var data = model.data;
						return {
							ctor: '_Tuple2',
							_0: _vito$cadet$Main$computeDataView(
								_elm_lang$core$Native_Utils.update(
									model,
									{
										data: _elm_lang$core$Native_Utils.update(
											data,
											{
												repos: A3(_elm_lang$core$Dict$insert, _p199.id, _p199, data.repos)
											}),
										allLabels: A3(
											_elm_lang$core$List$foldl,
											function (l) {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to refresh repo', _p160._0._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'AcceptCard':
					var _p200 = _p160._0.content;
					if (_p200.ctor === 'IssueCardContent') {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A2(_vito$cadet$Main$acceptIssue, model, _p200._0)
						};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				case 'CardAccepted':
					if (_p160._1.ctor === 'Ok') {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to accept card', _p160._1._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'RejectCard':
					var _p201 = _p160._0.content;
					if (_p201.ctor === 'IssueCardContent') {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A2(_vito$cadet$Main$rejectIssue, model, _p201._0)
						};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				case 'CardRejected':
					if (_p160._1.ctor === 'Ok') {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to reject card', _p160._1._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
						...
						F3(
							function (_p202, r, acc) {
								return A2(
									...
									r.milestones) ? acc : {
									ctor: '::',
									_0: A3(_vito$cadet$Main$createMilestone, model, r, _p204),
									_1: acc
								};
							}),
						{ctor: '[]'},
						...
						F3(
							function (_p205, r, acc) {
								...
								if (_p207.ctor === '::') {
									return {
										ctor: '::',
										_0: A3(_vito$cadet$Main$closeMilestone, model, r, _p207._0),
										_1: acc
									};
								} else {
									return acc;
						...
						F3(
							function (_p208, r, acc) {
								...
								if (_p210.ctor === '::') {
									return {
										ctor: '::',
										_0: A3(_vito$cadet$Main$deleteMilestone, model, r, _p210._0),
										_1: acc
									};
								} else {
									return acc;
				...
				case 'SetNewMilestoneName':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{newMilestoneName: _p160._0}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'CreateMilestone':
					var _p212 = model.newMilestoneName;
					if (_p212 === '') {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					} else {
						var _v102 = _vito$cadet$Main$MirrorMilestone(_p212),
							_v103 = model;
						msg = _v102;
						model = _v103;
						continue update;
				...
				case 'SetCardMilestone':
					var _p218 = _p160._0;
					var set = function () {
						var _p213 = _p218.content;
						if (_p213.ctor === 'IssueCardContent') {
							return A2(_vito$cadet$Main$setIssueMilestone, model, _p213._0);
						} else {
							return A2(_vito$cadet$Main$setPRMilestone, model, _p213._0);
						}
					}();
					var _p214 = _p160._1;
					if (_p214.ctor === 'Nothing') {
						...
						var _p215 = A2(_elm_lang$core$Dict$get, _p218.repo.id, model.data.repos);
						if (_p215.ctor === 'Just') {
							var _p217 = A2(
								_elm_lang$core$List$filter,
								function (_p216) {
							...
							if (_p217.ctor === '::') {
								return {
									...
									_0: model,
									_1: set(
										_elm_lang$core$Maybe$Just(_p217._0))
								};
							} else {
								return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
							}
				...
				case 'IssueMilestoneChanged':
					if (_p160._1.ctor === 'Ok') {
						return {
							...
							_1: A2(_vito$cadet$Backend$refreshIssue, _p160._0.id, _vito$cadet$Main$IssueRefreshed)
						};
					} else {
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to change milestone', _p160._1._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'IssueRefreshed':
					if (_p160._0.ctor === 'Ok') {
						var _p219 = _p160._0._0;
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									...
									allCards: A3(
										_elm_lang$core$Dict$insert,
										_p219.id,
										_vito$cadet$Main$issueCard(_p219),
										model.allCards)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to refresh issue', _p160._0._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'PRMilestoneChanged':
					if (_p160._1.ctor === 'Ok') {
						return {
							...
							_1: A2(_vito$cadet$Backend$refreshPR, _p160._0.id, _vito$cadet$Main$PRRefreshed)
						};
					} else {
						return A3(
							_elm_lang$core$Basics$flip,
				...
				default:
					if (_p160._0.ctor === 'Ok') {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to refresh pr', _p160._0._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
			}
		}
...
var _vito$cadet$Main$viewProject = F2(
	function (model, _p221) {
		var _p222 = _p221;
		var _p223 = _p222.project;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
										...
										_0: A2(
											_elm_lang$html$Html$a,
											{
												...
												_0: _elm_lang$html$Html_Attributes$href(
													A2(_elm_lang$core$Basics_ops['++'], '/projects/', _p223.name)),
												_1: {
													ctor: '::',
													_0: _vito$cadet$StrictEvents$onLeftClick(
														_vito$cadet$Main$SetPage(
															_vito$cadet$Main$ProjectPage(_p223.name))),
													_1: {ctor: '[]'}
												}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(_p223.name),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: A4(_vito$cadet$Main$viewProjectColumn, model, _p223, _elm_lang$core$Basics$identity, _p222.inFlight),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
	...
	var page = function () {
		...
		do {
			if (_p224.ctor === '[]') {
				...
				if (_p224._1.ctor === '::') {
					if ((_p224._0 === 'projects') && (_p224._1._1.ctor === '[]')) {
						return _vito$cadet$Main$SetPage(
							_vito$cadet$Main$ProjectPage(_p224._1._0));
					} else {
						break _v109_5;
					}
				} else {
						...
						if (_p225.ctor === 'Nothing') {
							...
							return A2(
								_elm_lang$html$Html$a,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href(_p226.url),
										_1: {ctor: '[]'}
									}
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$img,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$src(_p226.avatar),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(_p226.login),
										_1: {ctor: '[]'}
									}
								});
						}
	...
	var anticipatedCards = A2(
		...
		A2(
			...
			A2(
				_elm_lang$core$List$filter,
				function (_p227) {
					return !A3(_elm_lang$core$Basics$flip, _elm_lang$core$List$member, model.selectedCards, _p227);
				},
				model.anticipatedCards)));
						...
						},
						{
							...
							_0: function () {
								...
								switch (_p228.ctor) {
									...
									case 'ProjectPage':
										return A2(_vito$cadet$Main$viewProjectPage, model, _p228._0);
									case 'LabelsPage':
