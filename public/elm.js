								...
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return {repo: a, id: b, createdAt: c, updatedAt: d, url: e, state: f, isPullRequest: g, user: h, number: i, title: j, commentCount: k, reactions: l, labels: m};
												};
											};
										};
									};
...
var _vito$cadet$Main$viewIssue = F2(
	function (issue, extraCells) {
		...
		var infoCell = A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('issue-cell issue-info'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href(issue.repo.url),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$target('_blank'),
											_1: {ctor: '[]'}
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(issue.repo.name),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
		...
		var typeCell = A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('issue-cell issue-type'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: issue.isPullRequest ? (_elm_lang$core$Native_Utils.eq(issue.state, _vito$cadet$GitHub$IssueStateOpen) ? A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('emoji octicon octicon-git-pull-request gh-open'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}) : A2(
					_elm_lang$html$Html$i,
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('emoji octicon octicon-issue-opened gh-open'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}) : A2(
					_elm_lang$html$Html$i,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('emoji octicon octicon-issue-closed gh-closed'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'})),
				_1: {ctor: '[]'}
		...
		var cells = A2(_elm_lang$core$Basics_ops['++'], baseCells, extraCells);
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('issue-summary'),
				_1: {ctor: '[]'}
			},
			cells);
	});
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('cell-title'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
								...
								A2(
									...
									A2(
										...
										_elm_lang$core$Basics$toString(
											_elm_lang$core$List$length(entries)),
										')')))),
						_1: {ctor: '[]'}
					}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('cell-content'),
							_1: {ctor: '[]'}
						},
						A2(_elm_lang$core$List$map, viewEntry, entries)),
					_1: {ctor: '[]'}
				}
			});
	});
