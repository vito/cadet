		...
		while (true) {
			switch (msg.$) {
				...
				case 'EventReceived':
					...
					var data = _v7.b;
					var indexStr = _v7.c;
					var _v8 = $elm$core$String$toInt(indexStr);
					if (_v8.$ === 'Just') {
						var index = _v8.a;
...
var $author$project$Main$viewDashboardPage = function (model) {
	...
	var prIsReadyToMerge = function (prId) {
		return function (rs) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('dashboard-pane approved-pane')
					]),
				_List_fromArray(
					[
						A2(
...
var $author$project$Main$viewRepoPRs = F3(
	function (model, repoId, prIds) {
		var _v0 = A2($elm$core$Dict$get, repoId, model.repos);
		if (_v0.$ === 'Just') {
			var repo = _v0.a;
			return A2(
				$elm$html$Html$div,
	...
	function (a, b) {
		...
		if (_v0.a.$ === 'Just') {
			...
			if (_v0.b.$ === 'Just') {
				...
				var _v3 = _v0.a;
				var _v4 = _v0.b;
				return A2($elm$core$Basics$compare, a.ref, b.ref);
			}
		}
	});
...
var $author$project$ReleaseStatus$view = function (sir) {
	var refName = A3($elm$core$String$replace, 'refs/heads/', '', sir.ref);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
									...
									return A2(
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('create-milestone')
													]),
												(refName === 'master') ? _List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class('inline-major-minor')
															]),
														_List_Nil),
													...
													[
														$elm$html$Html$text('v'),
														$elm$html$Html$text(
														$author$project$ReleaseStatus$refMajorMinor(sir.ref)),
														$elm$html$Html$text('.'),
														A2(
														$elm$html$Html$input,
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class('inline-patch')
															]),
														_List_Nil)
													]))
											]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('all-releases')
					]),
				$elm$core$Dict$values(
