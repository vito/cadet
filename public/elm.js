	...
	if ((((((((_p1.ctor === 'Just') && (_p1._0.ctor === '::')) && (_p1._0._0.ctor === 'Just')) && (_p1._0._1.ctor === '::')) && (_p1._0._1._0.ctor === 'Just')) && (_p1._0._1._1.ctor === '::')) && (_p1._0._1._1._0.ctor === 'Just')) && (_p1._0._1._1._1.ctor === '[]')) {
		...
		if (((((((_p2.ctor === '::') && (_p2._0.ctor === 'Ok')) && (_p2._1.ctor === '::')) && (_p2._1._0.ctor === 'Ok')) && (_p2._1._1.ctor === '::')) && (_p2._1._1._0.ctor === 'Ok')) && (_p2._1._1._1.ctor === '[]')) {
			...
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 676, column: 17},
					end: {line: 684, column: 50}
				},
				_p2)('invalid hex');
		}
	} else {
...
var _vito$cadet$Main$issueRadiusWithFlair = function (nc) {
	var issue = nc.node.label.entity.value;
...
var _vito$cadet$Main$issueFlair = function (_p11) {
	...
	var issue = _p22.label.entity.value;
	var reactions = A2(
		_elm_lang$core$List$filter,
		function (_p13) {
			return A3(
		...
		function (i, _p14) {
			...
			if ((_p18.ctor === '::') && (_p18._1.ctor === '[]')) {
				...
				return _elm_lang$core$Native_Utils.crashCase(
					'Main',
					{
						start: {line: 529, column: 17},
						end: {line: 534, column: 49}
					},
					_p18)('impossible');
			}
		});
	var y = _p22.label.entity.y;
	var x = _p22.label.entity.x;
	return A2(
		_elm_lang$svg$Svg$g,
		{
			ctor: '::',
...
var _vito$cadet$Main$issueNode = function (_p23) {
	...
	var issue = _p27.label.entity.value;
	...
	var labelSegments = A2(
		...
		A2(
			...
			1));
	var y = _p27.label.entity.y;
	var x = _p27.label.entity.x;
	return A2(
		_elm_lang$svg$Svg$g,
		{
			ctor: '::',
...
var _vito$cadet$Main$issueNodeBounds = function (nc) {
	...
	var y = nc.node.label.entity.y;
	var x = nc.node.label.entity.x;
			...
			function (nc) {
				return {
					...
					_1: A2(
						...
						_elm_lang$core$Basics$toString(nc.node.label.entity.value.id),
...
var _vito$cadet$Main$nodeScore = function (fn) {
	return _vito$cadet$GitHub$issueScore(fn.entity.value);
};
...
var _vito$cadet$Main$issueGraphNode = F2(
	function (i, issue) {
		var canvas = 500;
		var _p46 = A2(
			_elm_lang$core$Random$step,
			A2(_elm_lang$core$Random$float, 0, canvas),
			_elm_lang$core$Random$initialSeed(i));
		var x = _p46._0;
		var s2 = _p46._1;
		var _p47 = A2(
			_elm_lang$core$Random$step,
		...
		return A2(
			...
			issue.id,
			{
				entity: {x: x, y: y, vx: 0.0, vy: 0.0, id: issue.id, value: issue}
			});
	});
var _vito$cadet$Main$forceGraph = function (graph) {
	var link = function (_p48) {
		var _p49 = _p48;
		var _p53 = _p49.to;
		var _p52 = _p49.from;
		var distance = function () {
			var _p50 = {
				ctor: '_Tuple2',
				_0: A2(_elm_community$graph$Graph$get, _p52, graph),
				_1: A2(_elm_community$graph$Graph$get, _p53, graph)
			};
			if (((_p50.ctor === '_Tuple2') && (_p50._0.ctor === 'Just')) && (_p50._1.ctor === 'Just')) {
				return 40 + (A2(
					_elm_lang$core$Basics$max,
					_elm_community$intdict$IntDict$size(_p50._1._0.incoming),
					_elm_community$intdict$IntDict$size(_p50._0._0.outgoing)) * 5);
			} else {
				return _elm_lang$core$Native_Utils.crashCase(
					'Main',
					{
						start: {line: 300, column: 21},
						end: {line: 305, column: 69}
					},
...
var _vito$cadet$Main$collectReferences = function (timelines) {
	return A3(
		_elm_lang$core$Dict$foldl,
		F3(
			function (targetIDStr, events, edges) {
				var targetID = function () {
					var _p54 = _elm_lang$core$String$toInt(targetIDStr);
					if (_p54.ctor === 'Ok') {
						return _p54._0;
					} else {
						return _elm_lang$core$Native_Utils.crashCase(
							'Main',
							{
								start: {line: 266, column: 21},
								end: {line: 271, column: 44}
							},
							_p54)(_p54._0);
					}
				}();
				return A2(
					...
					A2(
						...
						function (event) {
							var _p56 = event.source;
							if (_p56.ctor === 'Just') {
								var _p57 = _p56._0.issueID;
								if (_p57.ctor === 'Just') {
									return _elm_lang$core$Maybe$Just(
										{
											from: _p57._0,
...
var _vito$cadet$Main$edgesContains = function (nodeId) {
	return _elm_lang$core$List$any(
		function (_p58) {
			var _p59 = _p58;
			return _elm_lang$core$Native_Utils.eq(_p59.from, nodeId) || _elm_lang$core$Native_Utils.eq(_p59.to, nodeId);
		});
};
			...
			while (true) {
				...
				if (_p60.ctor === '[]') {
					...
					var hasNeither = A2(
						_elm_lang$core$List$filter,
						function (es) {
							return (!A2(_vito$cadet$Main$edgesContains, _p63.from, es)) && (!A2(_vito$cadet$Main$edgesContains, _p63.to, es));
						},
						acc);
					var hasTo = A2(
						_elm_lang$core$List$filter,
						_vito$cadet$Main$edgesContains(_p63.to),
						acc);
					var hasFrom = A2(
						_elm_lang$core$List$filter,
						_vito$cadet$Main$edgesContains(_p63.from),
						acc);
					var _p61 = {ctor: '_Tuple2', _0: hasFrom, _1: hasTo};
					_v25_4:
					do {
										...
										if (_p61._1._1.ctor === '[]') {
											var _v26 = _p64,
												...
												_0: {
													ctor: '::',
													_0: _p63,
													_1: A2(_elm_lang$core$Basics_ops['++'], _p61._0._0, _p61._1._0)
												},
												_1: hasNeither
											};
											edges = _v26;
...
var _vito$cadet$Main$computeGraphs = F2(
	function (model, data) {
		var references = _vito$cadet$Main$collectReferences(data.timelines);
		...
		var graph = A2(
			...
			A2(_elm_lang$core$List$indexedMap, _vito$cadet$Main$issueGraphNode, allIssues),
			references);
		return {
			ctor: '_Tuple2',
...
var _vito$cadet$Main$tickGraph = function (_p67) {
	...
	var list = _p69._1;
	return {
		graph: A2(_vito$cadet$Main$updateGraphWithList, _p71, list),
		simulation: newState
	};
};
var _vito$cadet$Main$update = F2(
	function (msg, model) {
		...
		switch (_p72.ctor) {
			...
			default:
				if (_p72._0.ctor === 'Ok') {
					return A2(_vito$cadet$Main$computeGraphs, model, _p72._0._0);
				} else {
					return A3(
						_elm_lang$core$Basics$flip,
						_elm_lang$core$Basics$always,
						A2(_elm_lang$core$Debug$log, 'error', _p72._0._0),
...
var _vito$cadet$Main$ForceNode = function (a) {
	return {entity: a};
};
