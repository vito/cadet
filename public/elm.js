			...
			while (true) {
				...
				if (_p7.ctor === '[]') {
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							start: {line: 2524, column: 25},
							end: {line: 2538, column: 57}
						},
						_p8)('impossible');
				}
			}
	...
	if ((((((((_p14.ctor === 'Just') && (_p14._0.ctor === '::')) && (_p14._0._0.ctor === 'Just')) && (_p14._0._1.ctor === '::')) && (_p14._0._1._0.ctor === 'Just')) && (_p14._0._1._1.ctor === '::')) && (_p14._0._1._1._0.ctor === 'Just')) && (_p14._0._1._1._1.ctor === '[]')) {
		...
		if (((((((_p15.ctor === '::') && (_p15._0.ctor === 'Ok')) && (_p15._1.ctor === '::')) && (_p15._1._0.ctor === 'Ok')) && (_p15._1._1.ctor === '::')) && (_p15._1._1._0.ctor === 'Ok')) && (_p15._1._1._1.ctor === '[]')) {
			...
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 2442, column: 17},
					end: {line: 2450, column: 50}
				},
				_p15)('invalid hex');
		}
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 2440, column: 9},
				end: {line: 2453, column: 42}
			},
			_p14)('invalid hex');
	}
};
			...
			_elm_lang$html$Html$img,
			{
				...
				_0: _elm_lang$html$Html_Attributes$class(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'card-actor ',
						A2(_vito$cadet$Main$activityClass, model.currentDate, _p28.createdAt))),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$src(
						A2(_elm_lang$core$Basics_ops['++'], _p28.actor.avatar, '&s=88')),
					_1: {
						ctor: '::',
...
var _vito$cadet$Main$issueRadius = F2(
	function (card, _p29) {
		...
		return 15 + ((_elm_lang$core$Basics$toFloat(
			_elm_community$intdict$IntDict$size(_p30.incoming)) / 2) + _elm_lang$core$Basics$toFloat(
			_elm_community$intdict$IntDict$size(_p30.outgoing) * 2));
	});
	...
	function (card, context) {
		...
		var emojiReactions = A3(
			...
			function (_p32) {
				...
				return {
					ctor: '_Tuple2',
					_0: reactionTypeEmoji(_p33.type_),
					_1: _p33.count
				};
			});
		var flairs = A2(
			...
			function (i, _p35) {
				...
				var segments = A2(
					_gampleman$elm_visualization$Visualization_Shape$pie,
					{
						...
						innerRadius: radius,
						outerRadius: (radius + _vito$cadet$Main$flairRadiusBase) + _elm_lang$core$Basics$toFloat(_p36._1),
						cornerRadius: 3,
						padRadius: 0
					},
					A2(
				...
				if ((_p39.ctor === '::') && (_p39._1.ctor === '[]')) {
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							start: {line: 1966, column: 17},
							end: {line: 1971, column: 49}
						},
						_p39)('impossible');
				}
			});
		return A3(
			...
			F2(
				function (i, _p41) {
					var _p42 = _p41;
					var arc = A2(reactionSegment, i, _p42);
					return A2(
						_elm_lang$svg$Svg$g,
						{
							ctor: '::',
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$svg$Svg$text(_p42._0),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _vito$cadet$Main$linkPath = F2(
	function (graph, edge) {
		var target = function () {
			...
			if (_p46.ctor === 'Just') {
				return {x: _p46._0.x, y: _p46._0.y};
			} else {
				return {x: 0, y: 0};
			}
		}();
...
var _vito$cadet$Main$viewNodeLowerUpper = F3(
	function (state, _p50, _p49) {
		var _p51 = _p50;
		var _p53 = _p51.node;
		var _p52 = _p49;
		var pos = {x: _p53.label.x, y: _p53.label.y};
		return {
			ctor: '_Tuple2',
			_0: {
				ctor: '::',
				_0: A3(_elm_lang$svg$Svg_Lazy$lazy2, _p53.label.value.viewLower, pos, state),
				_1: _p52._0
			},
			_1: {
				ctor: '::',
				_0: A3(_elm_lang$svg$Svg_Lazy$lazy2, _p53.label.value.viewUpper, pos, state),
				_1: _p52._1
			}
		};
	});
	...
	function (model, _p54) {
		...
		var links = A2(
			...
			_elm_lang$svg$Svg_Lazy$lazy(
				_vito$cadet$Main$linkPath(_p65)),
			_elm_community$graph$Graph$edges(_p65));
		var padding = 10;
		var nodeContexts = A3(
			_elm_community$graph$Graph$fold,
			F2(
		...
		var minX = A3(
			...
			F2(
				function (_p57, acc) {
					var _p58 = _p57;
					return A2(_elm_lang$core$Basics$min, _p58.x1, acc);
				}),
			999999,
			bounds) - padding;
		var minY = A3(
			...
			F2(
				function (_p59, acc) {
					var _p60 = _p59;
					return A2(_elm_lang$core$Basics$min, _p60.y1, acc);
				}),
			999999,
			bounds) - padding;
		var maxX = A3(
			...
			F2(
				function (_p61, acc) {
					var _p62 = _p61;
					return A2(_elm_lang$core$Basics$max, _p62.x2, acc);
				}),
			0,
			bounds) + padding;
		var width = maxX - minX;
		var maxY = A3(
			...
			F2(
				function (_p63, acc) {
					var _p64 = _p63;
					return A2(_elm_lang$core$Basics$max, _p64.y2, acc);
				}),
			0,
			bounds) + padding;
			...
			var graphScore = function (_p67) {
				return A3(
					...
					A2(
						...
						_elm_community$graph$Graph$nodes(_p67)));
			};
			return A2(
				_elm_lang$core$Basics$compare,
				graphScore(a.graph),
...
var _vito$cadet$Main$onlyOpenContentCards = function (model) {
	return _elm_lang$core$List$filter(
		function (_p69) {
			var _p70 = _p69;
			var _p71 = _p70.contentId;
			if (_p71.ctor === 'Just') {
				var _p72 = A2(_elm_lang$core$Dict$get, _p71._0, model.allCards);
				if (_p72.ctor === 'Just') {
					return _vito$cadet$Main$isOpen(_p72._0);
				} else {
					return false;
				}
			} else {
...
var _vito$cadet$Main$computeDataView = function (model) {
	...
	var cardsByMilestone = A3(
		_elm_lang$core$Dict$foldl,
		F3(
			function (_p85, card, acc) {
				var _p86 = card.milestone;
				if (_p86.ctor === 'Just') {
					return A3(
						_elm_lang$core$Dict$update,
						_p86._0.title,
	...
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			dataView: {cardsByMilestone: cardsByMilestone, allMilestones: allMilestones, nextMilestoneCards: nextMilestoneCards, reposByLabel: reposByLabel}
		});
};
var _vito$cadet$Main$IssueState = function (a) {
	return {ctor: 'IssueState', _0: a};
};
var _vito$cadet$Main$issueCard = function (_p87) {
	var _p88 = _p87;
	var _p89 = _p88;
	return {
		id: _p88.id,
		content: _vito$cadet$GitHubGraph$IssueCardContent(_p89),
		url: _p88.url,
		repo: _p88.repo,
		number: _p88.number,
		title: _p88.title,
		updatedAt: _p88.updatedAt,
		author: _p88.author,
		labels: A2(
			_elm_lang$core$List$map,
			function (_) {
			...
			_p88.labels),
		cards: _p88.cards,
		commentCount: _p88.commentCount,
		reactions: _p88.reactions,
		score: _vito$cadet$GitHubGraph$issueScore(_p89),
		state: _vito$cadet$Main$IssueState(_p88.state),
		milestone: _p88.milestone
	};
};
	...
	function (model, pr, mmilestone) {
		...
		if (_p90.ctor === 'Just') {
			return A2(
				...
				A3(_vito$cadet$GitHubGraph$setPullRequestMilestone, _p90._0.token, pr, mmilestone));
		} else {
	...
	function (model, issue, mmilestone) {
		...
		if (_p91.ctor === 'Just') {
			return A2(
				...
				A3(_vito$cadet$GitHubGraph$setIssueMilestone, _p91._0.token, issue, mmilestone));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, title) {
		...
		if (_p92.ctor === 'Just') {
			return A2(
				...
				A3(_vito$cadet$GitHubGraph$createRepoMilestone, _p92._0.token, repo, title));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, milestone) {
		...
		if (_p93.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$MilestoneChanged(repo),
				A3(_vito$cadet$GitHubGraph$closeRepoMilestone, _p93._0.token, repo, milestone));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, milestone) {
		...
		if (_p94.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$MilestoneChanged(repo),
				A3(_vito$cadet$GitHubGraph$deleteRepoMilestone, _p94._0.token, repo, milestone));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, issue) {
		...
		if (_p95.ctor === 'Just') {
			...
			var moveCardToBacklog = function (card) {
				var _p96 = A2(_elm_lang$core$Dict$get, card.project.id, model.data.projects);
				if (_p96.ctor === 'Just') {
					var _p98 = A2(
						_elm_lang$core$List$filter,
						function (_p97) {
					...
					if ((_p98.ctor === '::') && (_p98._1.ctor === '[]')) {
						return _elm_lang$core$Maybe$Just(
							{ctor: '_Tuple2', _0: _p98._0.id, _1: card.id});
					} else {
						return _elm_lang$core$Maybe$Nothing;
					}
				} else {
				...
				function (_p100) {
					...
					return A2(
						...
						A2(
							_elm_lang$core$Task$mapError,
							_elm_lang$core$Basics$toString,
							A4(_vito$cadet$GitHubGraph$moveCardAfter, _p102, _p101._0, _p101._1, _elm_lang$core$Maybe$Nothing)));
				},
				cardsToMove);
			return A2(
				_elm_lang$core$Task$attempt,
			...
			return A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$Task$andThen,
						function (_p105) {
							return A2(_vito$cadet$GitHubGraph$closeIssue, _p107, issue);
						},
						A2(
							_elm_lang$core$Task$andThen,
							function (_p106) {
							...
							A2(
								...
								_elm_lang$core$Basics$always(
									_elm_lang$core$Task$succeed(
										{ctor: '_Tuple0'})),
								A3(_vito$cadet$GitHubGraph$removeIssueLabel, _p107, issue, 'rejected'))))));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, label) {
		...
		if (_p108.ctor === 'Just') {
			return A2(
				...
				A4(_vito$cadet$GitHubGraph$createRepoLabel, _p108._0.token, repo, label.name, label.color));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, label1, label2) {
		...
		if (_p109.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$LabelChanged(repo),
				A5(_vito$cadet$GitHubGraph$updateRepoLabel, _p109._0.token, repo, label1, label2.name, label2.color));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
	...
	function (model, repo, label) {
		...
		if (_p110.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$LabelChanged(repo),
				A3(_vito$cadet$GitHubGraph$deleteRepoLabel, _p110._0.token, repo, label.name));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
					...
					},
					{
						...
						_0: A2(
							...
							},
							{
								ctor: '::',
								_0: function () {
									var _p117 = A2(_elm_lang$core$Dict$get, stateKey, model.editingLabels);
												...
												_0: A2(
													_elm_lang$html$Html$span,
													{
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _vito$cadet$Main$labelColorStyle(_p118.color),
																_1: {ctor: '[]'}
															}
														}
													},
												...
												_1: {
													...
													_0: A2(
														_elm_lang$html$Html$input,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$value(_p118.name),
																_1: {
																	ctor: '::',
																	_0: _vito$cadet$Main$labelColorStyle(_p118.color),
																	_1: {ctor: '[]'}
	...
	var labelRows = A3(
		...
		function (_p119) {
			...
			return A3(
				...
				model,
				{name: _p120._0._0, color: _p120._0._1},
				_p120._1);
		});
	var newLabel = A2(
		_elm_lang$html$Html$div,
...
var _vito$cadet$Main$viewCardNodeFlair = F5(
	function (card, radii, flair, _p121, state) {
		var _p122 = _p121;
		var projectHalo = A2(
...
var _vito$cadet$Main$viewCardNode = F5(
	function (card, radii, labels, _p123, state) {
		var _p124 = _p123;
		var circleWithNumber = function () {
			var _p125 = card.state;
			if (_p125.ctor === 'IssueState') {
				return {
					ctor: '::',
					_0: A2(
						_elm_lang$svg$Svg$circle,
			...
			_elm_lang$svg$Svg$g,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$transform(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(_p124.x),
							A2(
								_elm_lang$core$Basics_ops['++'],
								', ',
								A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(_p124.y),
									A2(
										_elm_lang$core$Basics_ops['++'],
										') scale(',
										A2(_elm_lang$core$Basics_ops['++'], scale, ')'))))))),
...
var _vito$cadet$Main$cardNode = F3(
	function (allLabels, card, context) {
		...
		return {
			...
			bounds: function (_p126) {
				var _p127 = _p126;
				var _p129 = _p127.y;
				var _p128 = _p127.x;
				return {x1: _p128 - radii.withFlair, y1: _p129 - radii.withFlair, x2: _p128 + radii.withFlair, y2: _p129 + radii.withFlair};
			},
			score: card.score
		};
	});
var _vito$cadet$Main$computeReferenceGraph = F2(
	function (data, allCards) {
		var applyWithContext = function (_p130) {
			var _p131 = _p130;
			var _p132 = _p131.node;
			var context = {incoming: _p131.incoming, outgoing: _p131.outgoing};
			return _elm_lang$core$Native_Utils.update(
				_p131,
				{
					node: _elm_lang$core$Native_Utils.update(
			...
			},
			{
				...
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: function () {
							var _p135 = card.state;
							if (_p135.ctor === 'IssueState') {
								if (_p135._0.ctor === 'IssueStateOpen') {
									return A2(
										_elm_lang$html$Html$span,
										{
											ctor: '::',
															...
															_0: function () {
																...
																if (_p136.ctor === 'Just') {
																	...
																	return A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$href(_p137.url),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$target('_blank'),
																				_1: {
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(_p137.login),
																			_1: {ctor: '[]'}
																		});
																} else {
...
var _vito$cadet$Main$moveCard = F3(
	function (model, _p138, cardId) {
		var _p139 = _p138;
		var _p141 = _p139.columnId;
		var _p140 = model.me;
		if (_p140.ctor === 'Just') {
			return A2(
				_elm_lang$core$Task$attempt,
				_vito$cadet$Main$CardMoved(_p141),
				A4(_vito$cadet$GitHubGraph$moveCardAfter, _p140._0.token, _p141, cardId, _p139.afterId));
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
var _vito$cadet$Main$addCard = F3(
	function (model, _p142, contentId) {
		var _p143 = _p142;
		var _p148 = _p143.columnId;
		var _p147 = _p143.afterId;
		var _p144 = model.me;
		if (_p144.ctor === 'Just') {
			var _p146 = _p144._0.token;
			var _p145 = A3(_vito$cadet$Main$contentCardId, model, _p143.projectId, contentId);
			if (_p145.ctor === 'Just') {
				return A2(
					_elm_lang$core$Task$attempt,
					_vito$cadet$Main$CardMoved(_p148),
					A4(_vito$cadet$GitHubGraph$moveCardAfter, _p146, _p148, _p145._0, _p147));
			} else {
				return A2(
					_elm_lang$core$Task$attempt,
					_vito$cadet$Main$CardMoved(_p148),
					A4(_vito$cadet$GitHubGraph$addContentCardAfter, _p146, _p148, contentId, _p147));
			}
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
...
var _vito$cadet$Main$viewProjectColumnCard = F4(
	function (model, project, col, ghCard) {
		...
		var _p149 = {ctor: '_Tuple2', _0: ghCard.note, _1: ghCard.contentId};
		_v73_2:
		do {
			if (_p149.ctor === '_Tuple2') {
				if (_p149._0.ctor === 'Just') {
					if (_p149._1.ctor === 'Nothing') {
						return {
							ctor: '::',
							_0: A4(
								_vito$cadet$Drag$draggable,
								...
								dragId,
								A3(_vito$cadet$Main$viewNoteCard, model, col, _p149._0._0)),
							_1: {
								ctor: '::',
								_0: A4(
									_vito$cadet$Drag$viewDropArea,
					...
					if (_p149._1.ctor === 'Just') {
						var _p150 = A2(_elm_lang$core$Dict$get, _p149._1._0, model.allCards);
						if (_p150.ctor === 'Just') {
							return {
								ctor: '::',
								_0: A4(
									...
									_vito$cadet$Main$ProjectDrag,
									dragId,
									A2(_vito$cadet$Main$viewCard, model, _p150._0)),
								_1: {
									ctor: '::',
									_0: A4(
										_vito$cadet$Drag$viewDropArea,
							...
							return _elm_lang$core$Native_Utils.crashCase(
								'Main',
								{
									start: {line: 1605, column: 17},
									end: {line: 1612, column: 70}
								},
								_p150)('impossible: content has no card');
						}
					} else {
						break _v73_2;
					}
		...
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 1598, column: 9},
				end: {line: 1615, column: 41}
			},
			_p149)('impossible');
	});
...
var _vito$cadet$Main$viewSingleProject = F2(
	function (model, _p153) {
		var _p154 = _p153;
		var _p155 = _p154.project;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(_p155.name),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
								...
								_0: A2(
									...
									},
									{
										...
										_0: A4(
											...
											model,
											_p155,
											_vito$cadet$Main$onlyOpenContentCards(model),
											_p154.done),
										_1: {ctor: '[]'}
									}),
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: A4(_vito$cadet$Main$viewProjectColumn, model, _p155, _elm_lang$core$Basics$identity, _p154.inFlight),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						A3(
							...
							function (backlog) {
								return A2(
									...
									{
										ctor: '::',
										_0: A4(_vito$cadet$Main$viewProjectColumn, model, _p155, _elm_lang$core$Basics$identity, backlog),
										_1: {ctor: '[]'}
									});
							}))),
				_1: {
						...
						},
						{
							...
							_1: {
								...
								_0: function () {
									var dropCandidate = {
										msgFunc: _vito$cadet$Main$MoveCardAfter,
										target: {projectId: _p155.id, columnId: _p154.icebox.id, afterId: _elm_lang$core$Maybe$Nothing}
									};
...
var _vito$cadet$Main$viewProjectPage = F2(
	function (model, name) {
		...
		var _p157 = mproject;
		if (_p157.ctor === 'Just') {
			return A2(_vito$cadet$Main$viewSingleProject, model, _p157._0);
		} else {
			...
			_0: A2(
				...
				function (_p158) {
					return _vito$cadet$Main$SetCurrentDate(
						_elm_lang$core$Date$fromTime(_p158));
				}),
			_1: {
				ctor: '::',
			...
			switch (_p159.ctor) {
								...
								case 'ProjectPage':
									return A2(
										...
										A2(
											_elm_lang$core$Dict$filter,
											function (_p161) {
												return _vito$cadet$Main$isInProject(_p160._0);
											},
											cards));
								case 'LabelsPage':
									return {ctor: '[]'};
				...
				case 'SetCurrentDate':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{currentDate: _p159._0}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'ProjectDrag':
					var dragModel = A2(_vito$cadet$Drag$update, _p159._0, model.projectDrag);
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{projectDrag: dragModel});
					var _p163 = dragModel;
					if (_p163.ctor === 'Dropped') {
						var _v80 = _p163._0.msg,
							_v81 = newModel;
						msg = _v80;
						model = _v81;
						continue update;
				...
				case 'MilestoneDrag':
					var dragModel = A2(_vito$cadet$Drag$update, _p159._0, model.milestoneDrag);
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
						{milestoneDrag: dragModel});
					var _p164 = dragModel;
					if (_p164.ctor === 'Dropped') {
						var _v83 = _p164._0.msg,
							_v84 = newModel;
						msg = _v83;
						model = _v84;
						continue update;
				...
				case 'MoveCardAfter':
					var _p166 = _p159._1;
					var _p165 = _p159._0;
					if (_p165.ctor === 'FromColumnCardSource') {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A3(_vito$cadet$Main$moveCard, model, _p166, _p165._0.cardId)
						};
					} else {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A3(_vito$cadet$Main$addCard, model, _p166, _p165._0.contentId)
						};
					}
				case 'CardMoved':
					if (_p159._1.ctor === 'Ok') {
						var _p170 = _p159._0;
						var _p167 = model.projectDrag;
						if (_p167.ctor === 'Dropped') {
							...
							var _p168 = _p167._0.source;
							if (_p168.ctor === 'FromColumnCardSource') {
								var _p169 = _p168._0;
								return _elm_lang$core$Native_Utils.eq(_p169.columnId, _p170) ? A3(refresh, false, _p170, model) : {
									ctor: '_Tuple2',
									_0: model,
									_1: A2(
										_vito$cadet$Backend$refreshCards,
										...
										A2(
											...
											A2(refresh, true, _p169.columnId),
											_p170))
								};
							} else {
								return A3(refresh, false, _p170, model);
							}
						} else {
							return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
						}
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to move card', _p159._1._0),
				...
				case 'CardsFetched':
					if (_p159._2.ctor === 'Ok') {
						...
						var newData = _elm_lang$core$Native_Utils.update(
							data,
							{
								columnCards: A3(_elm_lang$core$Dict$insert, _p159._1, _p159._2._0, data.columnCards)
							});
						return _p159._0(
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to refresh cards', _p159._2._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'SearchCards':
					if (_p159._0 === '') {
						...
						var cardMatch = function (_p171) {
							var _p172 = _p171;
							return A2(
								_elm_lang$core$String$contains,
								_elm_lang$core$String$toLower(_p159._0),
								_elm_lang$core$String$toLower(_p172.title)) ? true : false;
						};
				...
				case 'SelectCard':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								selectedCards: A2(_elm_lang$core$List$member, _p173, model.selectedCards) ? model.selectedCards : A2(
									_elm_lang$core$Basics_ops['++'],
									model.selectedCards,
									{
										ctor: '::',
				...
				case 'HighlightNode':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								highlightedNode: _elm_lang$core$Maybe$Just(_p159._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				...
				case 'AnticipateCardFromNode':
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								anticipatedCards: {ctor: '::', _0: _p174, _1: model.anticipatedCards},
								highlightedCard: _elm_lang$core$Maybe$Just(_p174)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				...
				case 'MeFetched':
					if (_p159._0.ctor === 'Ok') {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'error fetching self', _p159._0._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'DataFetched':
					if (_p159._0.ctor === 'Ok') {
						var _p178 = _p159._0._0;
						var allLabels = A3(
							_elm_lang$core$Dict$foldl,
							F3(
								function (_p175, r, ls) {
							...
							_0: _vito$cadet$Main$computeDataView(
								_elm_lang$core$Native_Utils.update(
									model,
									{
										...
										allCards: allCards,
										allLabels: allLabels,
										cardGraphs: A2(model.computeGraph, _p178, allCards)
									})),
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'error fetching data', _p159._0._0),
							{
								ctor: '_Tuple2',
								_0: model,
								_1: _vito$cadet$Backend$pollData(_vito$cadet$Main$DataFetched)
						...
						F3(
							function (_p179, r, acc) {
								...
								if (_p181.ctor === '[]') {
									return {
										ctor: '::',
										_0: A3(_vito$cadet$Main$createLabel, model, r, _p183),
										_1: acc
									};
								} else {
									var _p182 = _p181._0;
									return _elm_lang$core$Native_Utils.eq(_p182.color, _p183.color) ? acc : {
										ctor: '::',
										_0: A4(_vito$cadet$Main$updateLabel, model, r, _p182, _p183),
										_1: acc
									};
								}
							}),
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								deletingLabels: A2(
									_elm_lang$core$Set$insert,
									_vito$cadet$Main$labelKey(_p159._0),
						...
						F3(
							function (_p184, r, acc) {
								...
								if (_p185.ctor === '[]') {
									...
									return {
										ctor: '::',
										_0: A3(_vito$cadet$Main$deleteLabel, model, r, _p185._0),
										_1: acc
									};
								}
							}),
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									editingLabels: A3(
										_elm_lang$core$Dict$insert,
										_vito$cadet$Main$labelKey(_p191),
										_vito$cadet$Main$randomizeColor(_p190._0),
										model.editingLabels)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
						...
						var cmds = A3(
							...
							F3(
								function (_p193, r, acc) {
									var _p194 = A2(
										_elm_lang$core$List$filter,
										_vito$cadet$Main$matchesLabel(_p195),
										r.labels);
									if (_p194.ctor === '::') {
										return {
											ctor: '::',
											_0: A4(_vito$cadet$Main$updateLabel, model, r, _p194._0, _p192._0),
											_1: acc
										};
									} else {
										return acc;
				...
				case 'CreateLabel':
					if (_elm_lang$core$Native_Utils.eq(model.newLabel.name, '')) {
						...
						var _v94 = _vito$cadet$Main$MirrorLabel(model.newLabel),
							_v95 = _elm_lang$core$Native_Utils.update(
							model,
							{
				...
				case 'LabelChanged':
					if (_p159._1.ctor === 'Ok') {
						var _p197 = _p159._0;
						var repoSel = {owner: _p197.owner, name: _p197.name};
						return {
							ctor: '_Tuple2',
							_0: model,
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to modify labels', _p159._1._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'RepoRefreshed':
					if (_p159._0.ctor === 'Ok') {
						var _p198 = _p159._0._0;
						var data = model.data;
						return {
							ctor: '_Tuple2',
							_0: _vito$cadet$Main$computeDataView(
								_elm_lang$core$Native_Utils.update(
									model,
									{
										data: _elm_lang$core$Native_Utils.update(
											data,
											{
												repos: A3(_elm_lang$core$Dict$insert, _p198.id, _p198, data.repos)
											}),
										allLabels: A3(
											_elm_lang$core$List$foldl,
											function (l) {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to refresh repo', _p159._0._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'AcceptCard':
					var _p199 = _p159._0.content;
					if (_p199.ctor === 'IssueCardContent') {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A2(_vito$cadet$Main$acceptIssue, model, _p199._0)
						};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				case 'CardAccepted':
					if (_p159._1.ctor === 'Ok') {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to accept card', _p159._1._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'RejectCard':
					var _p200 = _p159._0.content;
					if (_p200.ctor === 'IssueCardContent') {
						return {
							ctor: '_Tuple2',
							_0: model,
							_1: A2(_vito$cadet$Main$rejectIssue, model, _p200._0)
						};
					} else {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					}
				case 'CardRejected':
					if (_p159._1.ctor === 'Ok') {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to reject card', _p159._1._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
						...
						F3(
							function (_p201, r, acc) {
								return A2(
									...
									r.milestones) ? acc : {
									ctor: '::',
									_0: A3(_vito$cadet$Main$createMilestone, model, r, _p203),
									_1: acc
								};
							}),
						{ctor: '[]'},
						...
						F3(
							function (_p204, r, acc) {
								...
								if (_p206.ctor === '::') {
									return {
										ctor: '::',
										_0: A3(_vito$cadet$Main$closeMilestone, model, r, _p206._0),
										_1: acc
									};
								} else {
									return acc;
						...
						F3(
							function (_p207, r, acc) {
								...
								if (_p209.ctor === '::') {
									return {
										ctor: '::',
										_0: A3(_vito$cadet$Main$deleteMilestone, model, r, _p209._0),
										_1: acc
									};
								} else {
									return acc;
				...
				case 'SetNewMilestoneName':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{newMilestoneName: _p159._0}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'CreateMilestone':
					var _p211 = model.newMilestoneName;
					if (_p211 === '') {
						return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					} else {
						var _v101 = _vito$cadet$Main$MirrorMilestone(_p211),
							_v102 = model;
						msg = _v101;
						model = _v102;
						continue update;
				...
				case 'SetCardMilestone':
					var _p217 = _p159._0;
					var set = function () {
						var _p212 = _p217.content;
						if (_p212.ctor === 'IssueCardContent') {
							return A2(_vito$cadet$Main$setIssueMilestone, model, _p212._0);
						} else {
							return A2(_vito$cadet$Main$setPRMilestone, model, _p212._0);
						}
					}();
					var _p213 = _p159._1;
					if (_p213.ctor === 'Nothing') {
						...
						var _p214 = A2(_elm_lang$core$Dict$get, _p217.repo.id, model.data.repos);
						if (_p214.ctor === 'Just') {
							var _p216 = A2(
								_elm_lang$core$List$filter,
								function (_p215) {
							...
							if (_p216.ctor === '::') {
								return {
									...
									_0: model,
									_1: set(
										_elm_lang$core$Maybe$Just(_p216._0))
								};
							} else {
								return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
							}
				...
				case 'IssueMilestoneChanged':
					if (_p159._1.ctor === 'Ok') {
						return {
							...
							_1: A2(_vito$cadet$Backend$refreshIssue, _p159._0.id, _vito$cadet$Main$IssueRefreshed)
						};
					} else {
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to change milestone', _p159._1._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'IssueRefreshed':
					if (_p159._0.ctor === 'Ok') {
						var _p218 = _p159._0._0;
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									...
									allCards: A3(
										_elm_lang$core$Dict$insert,
										_p218.id,
										_vito$cadet$Main$issueCard(_p218),
										model.allCards)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to refresh issue', _p159._0._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
				case 'PRMilestoneChanged':
					if (_p159._1.ctor === 'Ok') {
						return {
							...
							_1: A2(_vito$cadet$Backend$refreshPR, _p159._0.id, _vito$cadet$Main$PRRefreshed)
						};
					} else {
						return A3(
							_elm_lang$core$Basics$flip,
				...
				default:
					if (_p159._0.ctor === 'Ok') {
						...
						return A3(
							_elm_lang$core$Basics$flip,
							_elm_lang$core$Basics$always,
							A2(_elm_lang$core$Debug$log, 'failed to refresh pr', _p159._0._0),
							{ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none});
					}
			}
		}
...
var _vito$cadet$Main$viewProject = F2(
	function (model, _p220) {
		var _p221 = _p220;
		var _p222 = _p221.project;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
										...
										_0: A2(
											_elm_lang$html$Html$a,
											{
												...
												_0: _elm_lang$html$Html_Attributes$href(
													A2(_elm_lang$core$Basics_ops['++'], '/projects/', _p222.name)),
												_1: {
													ctor: '::',
													_0: _vito$cadet$StrictEvents$onLeftClick(
														_vito$cadet$Main$SetPage(
															_vito$cadet$Main$ProjectPage(_p222.name))),
													_1: {ctor: '[]'}
												}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(_p222.name),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: A4(_vito$cadet$Main$viewProjectColumn, model, _p222, _elm_lang$core$Basics$identity, _p221.inFlight),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
	...
	var page = function () {
		...
		do {
			if (_p223.ctor === '[]') {
				...
				if (_p223._1.ctor === '::') {
					if ((_p223._0 === 'projects') && (_p223._1._1.ctor === '[]')) {
						return _vito$cadet$Main$SetPage(
							_vito$cadet$Main$ProjectPage(_p223._1._0));
					} else {
						break _v108_5;
					}
				} else {
						...
						if (_p224.ctor === 'Nothing') {
							...
							return A2(
								_elm_lang$html$Html$a,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href(_p225.url),
										_1: {ctor: '[]'}
									}
								},
								{
									...
									_0: A2(
										_elm_lang$html$Html$img,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$src(_p225.avatar),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(_p225.login),
										_1: {ctor: '[]'}
									}
								});
						}
	...
	var anticipatedCards = A2(
		...
		A2(
			...
			A2(
				_elm_lang$core$List$filter,
				function (_p226) {
					return !A3(_elm_lang$core$Basics$flip, _elm_lang$core$List$member, model.selectedCards, _p226);
				},
				model.anticipatedCards)));
						...
						},
						{
							...
							_0: function () {
								...
								switch (_p227.ctor) {
									...
									case 'ProjectPage':
										return A2(_vito$cadet$Main$viewProjectPage, model, _p227._0);
									case 'LabelsPage':
