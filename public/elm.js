...
var _vito$cadet$GitHub$Repo = F7(
	function (a, b, c, d, e, f, g) {
		return {value: a, id: b, url: c, htmlURL: d, owner: e, name: f, openIssues: g};
	});
									...
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return {value: a, id: b, url: c, htmlURL: d, createdAt: e, updatedAt: f, state: g, isPullRequest: h, user: i, number: j, title: k, commentCount: l, reactions: m, labels: n};
													};
												};
											};
										};
...
var _vito$cadet$Main$hexBrightness = function (h) {
	var _p0 = A2(_elm_lang$core$Basics$compare, h, (255 / 2) | 0);
	switch (_p0.ctor) {
		case 'LT':
			return -1;
		case 'EQ':
...
var _vito$cadet$Main$colorIsLight = function (hex) {
	...
	var _p1 = A2(
		...
		matches);
	if ((((((((_p1.ctor === 'Just') && (_p1._0.ctor === '::')) && (_p1._0._0.ctor === 'Just')) && (_p1._0._1.ctor === '::')) && (_p1._0._1._0.ctor === 'Just')) && (_p1._0._1._1.ctor === '::')) && (_p1._0._1._1._0.ctor === 'Just')) && (_p1._0._1._1._1.ctor === '[]')) {
		var _p2 = A2(
			_elm_lang$core$List$map,
			_fredcy$elm_parseint$ParseInt$parseIntHex,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _p1._0._1._1._0._0,
						_1: {ctor: '[]'}
					}
				}
			});
		if (((((((_p2.ctor === '::') && (_p2._0.ctor === 'Ok')) && (_p2._1.ctor === '::')) && (_p2._1._0.ctor === 'Ok')) && (_p2._1._1.ctor === '::')) && (_p2._1._1._0.ctor === 'Ok')) && (_p2._1._1._1.ctor === '[]')) {
			return (_elm_lang$core$Native_Utils.cmp(
				(_vito$cadet$Main$hexBrightness(_p2._0._0) + _vito$cadet$Main$hexBrightness(_p2._1._0._0)) + _vito$cadet$Main$hexBrightness(_p2._1._1._0._0),
				0) > 0) ? true : false;
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 719, column: 17},
					end: {line: 727, column: 50}
				},
				_p2)('invalid hex');
		}
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 717, column: 9},
				end: {line: 730, column: 42}
			},
			_p1)('invalid hex');
	}
};
var _vito$cadet$Main$viewIssueLabel = function (_p5) {
	var _p6 = _p5;
	var _p7 = _p6.color;
	return A2(
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'background-color',
							_1: A2(_elm_lang$core$Basics_ops['++'], '#', _p7)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'color',
								_1: _vito$cadet$Main$colorIsLight(_p7) ? 'rgba(0, 0, 0, .8)' : '#fff'
							},
							_1: {ctor: '[]'}
						}
					}),
...
var _vito$cadet$Main$issueRadius = function (_p8) {
	var _p9 = _p8;
	return 15 + ((_elm_lang$core$Basics$toFloat(
		_elm_community$intdict$IntDict$size(_p9.incoming)) / 2) + _elm_lang$core$Basics$toFloat(
		_elm_community$intdict$IntDict$size(_p9.outgoing) * 2));
};
var _vito$cadet$Main$issueRadiusWithLabels = function (_p10) {
	return A2(
		F2(
			function (x, y) {
				return x + y;
		...
		3,
		_vito$cadet$Main$issueRadius(_p10));
};
var _vito$cadet$Main$issueRadiusWithFlair = function (nc) {
	var issue = nc.node.label.value;
	var reactionCounts = A2(
		_elm_lang$core$List$map,
		_elm_lang$core$Tuple$second,
		_vito$cadet$GitHub$reactionCodes(issue.reactions));
	var highestFlair = A3(
		_elm_lang$core$List$foldl,
		F2(
			function (num, acc) {
		...
		0,
		{ctor: '::', _0: issue.commentCount, _1: reactionCounts});
...
var _vito$cadet$Main$issueFlair = function (_p11) {
	var _p12 = _p11;
	var _p22 = _p12._0.node;
	...
	var radius = _vito$cadet$Main$issueRadiusWithLabels(_p12._0);
	var issue = _p22.label.value;
	var reactions = A2(
		_elm_lang$core$List$filter,
		function (_p13) {
			return A3(
		...
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: '💬', _1: issue.commentCount},
			_1: _vito$cadet$GitHub$reactionCodes(issue.reactions)
		});
		...
		function (i, _p14) {
			...
			var segments = A2(
				_gampleman$elm_visualization$Visualization_Shape$pie,
				{
					...
					innerRadius: radius,
					outerRadius: (radius + _vito$cadet$Main$flairRadiusBase) + _elm_lang$core$Basics$toFloat(_p15._1),
					cornerRadius: 3,
					padRadius: 0
				},
				A2(
					_elm_lang$core$List$repeat,
					_elm_lang$core$List$length(reactions),
					1));
			var _p18 = A2(
			...
			if ((_p18.ctor === '::') && (_p18._1.ctor === '[]')) {
				...
				return _elm_lang$core$Native_Utils.crashCase(
					'Main',
					{
						start: {line: 571, column: 17},
						end: {line: 576, column: 49}
					},
					_p18)('impossible');
			}
		});
	...
	return A2(
		...
		A2(
			...
			F2(
				function (i, _p20) {
					var _p21 = _p20;
					var arc = A2(reactionSegment, i, _p21);
					return A2(
						_elm_lang$svg$Svg$g,
						{
							ctor: '::',
						...
						},
						{
							...
							_0: A2(
								_elm_lang$svg$Svg$path,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$fill('rgba(255, 255, 255, .3)'),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$svg$Svg$text(_p21._0),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _vito$cadet$Main$linkPath = F2(
	function (graph, edge) {
		var target = function () {
			...
			if (_p24.ctor === 'Just') {
				return {x: _p24._0.x, y: _p24._0.y};
			} else {
				return {x: 0, y: 0};
			}
		}();
		var source = function () {
			...
			if (_p26.ctor === 'Just') {
				return {x: _p26._0.x, y: _p26._0.y};
			} else {
				return {x: 0, y: 0};
			}
		}();
...
var _vito$cadet$Main$issueNodeBounds = function (nc) {
	var radius = _vito$cadet$Main$issueRadiusWithFlair(nc);
...
var _vito$cadet$Main$nodeScore = function (fn) {
	return _vito$cadet$GitHub$issueScore(fn.value);
};
			...
			var graphScore = function (_p28) {
				return A3(
					...
					A2(
						...
						_elm_community$graph$Graph$nodes(_p28)));
			};
			return A2(
				_elm_lang$core$Basics$compare,
				graphScore(a.graph),
...
var _vito$cadet$Main$viewBubble = F2(
	function (model, issueId) {
		var graphs = A2(
			_elm_lang$core$List$filter,
			_elm_community$graph$Graph$member(issueId),
			A2(
				_elm_lang$core$List$map,
				function (_) {
					return _.graph;
		...
		var node = function () {
			...
			if ((_p30.ctor === '::') && (_p30._1.ctor === '[]')) {
				return A2(_elm_community$graph$Graph$get, issueId, _p30._0);
			} else {
				return _elm_lang$core$Native_Utils.crashCase(
					'Main',
					{
						start: {line: 386, column: 13},
						end: {line: 391, column: 45}
					},
					_p30)('impossible');
			}
		}();
	...
	function (s1, _p32, issue) {
		...
		var _p34 = A2(
			...
			A2(
				...
				0,
				_elm_lang$core$Basics$toFloat(_p33.width)),
			s1);
		var x = _p34._0;
		var s2 = _p34._1;
		var _p35 = A2(
			...
			A2(
				_elm_lang$core$Random$float,
				0,
				_elm_lang$core$Basics$toFloat(_p33.height)),
			s2);
		var y = _p35._0;
		var s3 = _p35._1;
		return {
...
var _vito$cadet$Main$forceGraph = function (graph) {
	var link = function (_p36) {
		var _p37 = _p36;
		var _p41 = _p37.to;
		var _p40 = _p37.from;
		var distance = function () {
			var _p38 = {
				ctor: '_Tuple2',
				_0: A2(_elm_community$graph$Graph$get, _p40, graph),
				_1: A2(_elm_community$graph$Graph$get, _p41, graph)
			};
			if (((_p38.ctor === '_Tuple2') && (_p38._0.ctor === 'Just')) && (_p38._1.ctor === 'Just')) {
				return 40 + (A2(
					_elm_lang$core$Basics$max,
					_elm_community$intdict$IntDict$size(_p38._1._0.incoming),
					_elm_community$intdict$IntDict$size(_p38._0._0.outgoing)) * 5);
			} else {
				return _elm_lang$core$Native_Utils.crashCase(
					'Main',
					{
						start: {line: 321, column: 21},
						end: {line: 326, column: 69}
					},
					_p38)('impossible: unknown target');
			}
		}();
		return {
			source: _p40,
...
var _vito$cadet$Main$edgesContains = function (nodeId) {
	return _elm_lang$core$List$any(
		function (_p42) {
			var _p43 = _p42;
			return _elm_lang$core$Native_Utils.eq(_p43.from, nodeId) || _elm_lang$core$Native_Utils.eq(_p43.to, nodeId);
		});
};
			...
			while (true) {
				...
				if (_p44.ctor === '[]') {
					...
					var hasNeither = A2(
						_elm_lang$core$List$filter,
						function (es) {
							return (!A2(_vito$cadet$Main$edgesContains, _p47.from, es)) && (!A2(_vito$cadet$Main$edgesContains, _p47.to, es));
						},
						acc);
					var hasTo = A2(
						_elm_lang$core$List$filter,
						_vito$cadet$Main$edgesContains(_p47.to),
						acc);
					var hasFrom = A2(
						_elm_lang$core$List$filter,
						_vito$cadet$Main$edgesContains(_p47.from),
						acc);
					var _p45 = {ctor: '_Tuple2', _0: hasFrom, _1: hasTo};
					_v18_4:
					do {
										...
										if (_p45._1._1.ctor === '[]') {
											var _v19 = _p48,
												...
												_0: {
													ctor: '::',
													_0: _p47,
													_1: A2(_elm_lang$core$Basics_ops['++'], _p45._0._0, _p45._1._0)
												},
												_1: hasNeither
											};
											edges = _v19;
...
var _vito$cadet$Main$tickGraph = function (_p50) {
	var _p51 = _p50;
	var _p53 = _p51.graph;
	var _p52 = A2(
		...
		A2(
			...
			_elm_community$graph$Graph$nodes(_p53)));
	var newState = _p52._0;
	var list = _p52._1;
	return {
		graph: A2(_vito$cadet$Main$updateGraphWithList, _p53, list),
		simulation: newState
	};
};
			...
			case 'Tick':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							issueGraphs: A2(_elm_lang$core$List$map, _vito$cadet$Main$tickGraph, model.issueGraphs)
						}),
			...
			case 'RevealIssue':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							issueBubbles: A2(_elm_lang$core$Set$insert, _p54._0, model.issueBubbles)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				if (_p54._0.ctor === 'Ok') {
					...
					var references = A3(
						_elm_lang$core$Dict$foldl,
						F3(
							function (targetIDStr, events, pairs) {
								var targetID = function () {
									var _p55 = _elm_lang$core$String$toInt(targetIDStr);
									if (_p55.ctor === 'Ok') {
										return _p55._0;
									} else {
										return _elm_lang$core$Native_Utils.crashCase(
											'Main',
											{
												start: {line: 257, column: 37},
												end: {line: 262, column: 60}
											},
											_p55)(_p55._0);
									}
								}();
								return A2(
									...
									A2(
										...
										function (event) {
											var _p57 = event.source;
											if (_p57.ctor === 'Just') {
												var _p58 = _p57._0.issueID;
												if (_p58.ctor === 'Just') {
													return _elm_lang$core$Maybe$Just(
														{ctor: '_Tuple2', _0: targetID, _1: _p58._0});
												} else {
													return _elm_lang$core$Maybe$Nothing;
												}
											} else {
						...
						{ctor: '[]'},
						_p66.timelines);
					var allEvents = _elm_lang$core$List$concat(
						_elm_lang$core$Dict$values(_p66.timelines));
					var allIssues = _elm_lang$core$List$concat(
						_elm_lang$core$Dict$values(_p66.issues));
					var graph = A2(
						...
						_elm_lang$core$Tuple$first(
							A3(
								...
								F2(
									function (issue, _p59) {
										var _p60 = _p59;
										var _p61 = A3(_vito$cadet$Main$issueEntity, _p60._1, model.config.windowSize, issue);
										var entity = _p61._0;
										var nextSeed = _p61._1;
										return {
											ctor: '_Tuple2',
											_0: {
												ctor: '::',
									...
									}),
								{
									ctor: '_Tuple2',
									_0: {ctor: '[]'},
									_1: _elm_lang$core$Random$initialSeed(1)
								},
								allIssues)),
						{ctor: '[]'});
					var wiredGraph = A3(
						...
						F2(
							function (_p62, graph) {
								...
								return A2(
									...
									function (nc) {
										return _elm_lang$core$Native_Utils.eq(nc.node.id, _p64) ? _elm_lang$core$Native_Utils.update(
											nc,
											{
												outgoing: A3(
													_elm_community$intdict$IntDict$insert,
													...
													{ctor: '_Tuple0'},
													nc.outgoing)
											}) : (_elm_lang$core$Native_Utils.eq(nc.node.id, _p65) ? _elm_lang$core$Native_Utils.update(
											nc,
											{
												incoming: A3(
													_elm_community$intdict$IntDict$insert,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								repos: _p66.repositories,
								repoIssues: _p66.issues,
								issueTimelines: _p66.timelines,
								issueGraphs: A2(
									_elm_lang$core$List$map,
									_vito$cadet$Main$forceGraph,
									_vito$cadet$Main$subGraphs(wiredGraph))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return A3(
						_elm_lang$core$Basics$flip,
						_elm_lang$core$Basics$always,
						A2(_elm_lang$core$Debug$log, 'error', _p54._0._0),
...
var _vito$cadet$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {config: a, repos: b, repoIssues: c, issueTimelines: d, issueGraphs: e, issueBubbles: f};
	});
var _vito$cadet$Main$ForceGraph = F2(
	function (a, b) {
		return {graph: a, simulation: b};
	});
var _vito$cadet$Main$Data = F3(
	function (a, b, c) {
		return {repositories: a, issues: b, timelines: c};
	});
var _vito$cadet$Main$decodeData = A2(
	_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
	A2(
		_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
		A2(
			_elm_community$json_extra$Json_Decode_Extra_ops['|:'],
			_elm_lang$core$Json_Decode$succeed(_vito$cadet$Main$Data),
			A2(
				_elm_lang$core$Json_Decode$field,
				'repositories',
...
var _vito$cadet$Main$RevealIssue = function (a) {
	return {ctor: 'RevealIssue', _0: a};
};
var _vito$cadet$Main$issueNode = function (_p67) {
	var _p68 = _p67;
	var _p71 = _p68._0.node;
	var radius = _vito$cadet$Main$issueRadius(_p68._0);
	var issue = _p71.label.value;
		...
		_elm_lang$svg$Svg$g,
		{
			...
			_1: {
				...
				_0: _elm_lang$svg$Svg_Events$onMouseOver(
					_vito$cadet$Main$RevealIssue(issue.id)),
				_1: {ctor: '[]'}
			}
		},
		{
							...
							_elm_lang$svg$Svg$circle,
							{
								...
								_1: {
									...
									_0: _elm_lang$svg$Svg_Attributes$fill(
										issue.isPullRequest ? '#28a745' : '#fff'),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
								...
								_elm_lang$svg$Svg$text_,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$fill(
												issue.isPullRequest ? '#fff' : '#C6A49A'),
											_1: {ctor: '[]'}
										}
									}
								},
	...
	function (model, _p72) {
			...
			function (nc) {
				return {
					...
					_1: A2(
						...
						_elm_lang$core$Basics$toString(nc.node.label.value.id),
						model.issueTimelines)
				};
			},
			nodeContexts);
		...
		var minX = A3(
			...
			F2(
				function (_p74, acc) {
					var _p75 = _p74;
					return A2(_elm_lang$core$Basics$min, _p75._0, acc);
				}),
			999999,
			bounds) - padding;
		var minY = A3(
			...
			F2(
				function (_p76, acc) {
					var _p77 = _p76;
					return A2(_elm_lang$core$Basics$min, _p77._1, acc);
				}),
			999999,
			bounds) - padding;
		var maxX = A3(
			...
			F2(
				function (_p78, acc) {
					var _p79 = _p78;
					return A2(_elm_lang$core$Basics$max, _p79._2, acc);
				}),
			0,
			bounds) + padding;
		var width = maxX - minX;
		var maxY = A3(
			...
			F2(
				function (_p80, acc) {
					var _p81 = _p80;
					return A2(_elm_lang$core$Basics$max, _p81._3, acc);
				}),
			0,
			bounds) + padding;
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_vito$cadet$Main$linkPath(_p82),
						_elm_community$graph$Graph$edges(_p82))),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$svg$Svg$g,
						...
						A2(_elm_lang$core$List$map, _vito$cadet$Main$issueFlair, issues)),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$svg$Svg$g,
							...
							A2(_elm_lang$core$List$map, _vito$cadet$Main$issueNode, issues)),
						_1: {ctor: '[]'}
					}
				}
			});
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					A2(
						_elm_lang$core$List$map,
						_vito$cadet$Main$viewBubble(model),
						_elm_lang$core$Set$toList(model.issueBubbles))),
				_1: {ctor: '[]'}
			}
		});
};
...
var _vito$cadet$Main$fetchData = A2(
	_elm_lang$core$Task$attempt,
	_vito$cadet$Main$DataFetched,
	_lukewestby$elm_http_builder$HttpBuilder$toTask(
		A2(
			_lukewestby$elm_http_builder$HttpBuilder$withExpect,
			_elm_lang$http$Http$expectJson(_vito$cadet$Main$decodeData),
...
var _vito$cadet$Main$init = function (config) {
	return {
		...
		_0: {
			config: config,
			repos: {ctor: '[]'},
			repoIssues: _elm_lang$core$Dict$empty,
			issueTimelines: _elm_lang$core$Dict$empty,
			issueGraphs: {ctor: '[]'},
			issueBubbles: _elm_lang$core$Set$empty
		},
		_1: _vito$cadet$Main$fetchData
	};
};
