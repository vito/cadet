...
var _vito$cadet$Main$sameIssueOrPR = F2(
	function (a, b) {
		var _p0 = {ctor: '_Tuple2', _0: a, _1: b};
		_v0_2:
		do {
			if (_p0.ctor === '_Tuple2') {
				if (_p0._0.ctor === 'Issue') {
					if (_p0._1.ctor === 'Issue') {
						return _elm_lang$core$Native_Utils.eq(_p0._0._0.id, _p0._1._0.id);
					} else {
						break _v0_2;
					}
				} else {
...
var _vito$cadet$Main$issueNodeBounds = function (nc) {
	var radius = nc.node.label.value.radii.withFlair;
	var y = nc.node.label.y;
	var x = nc.node.label.x;
	return {ctor: '_Tuple4', _0: x - radius, _1: y - radius, _2: x + radius, _3: y + radius};
};
var _vito$cadet$Main$subEdges = function (edges) {
	var edgesContains = function (nodeId) {
		return _elm_lang$core$List$any(
			function (_p1) {
				var _p2 = _p1;
				return _elm_lang$core$Native_Utils.eq(_p2.from, nodeId) || _elm_lang$core$Native_Utils.eq(_p2.to, nodeId);
			});
	};
	var go = F2(
		function (edges, acc) {
			...
			while (true) {
				...
				if (_p3.ctor === '[]') {
					...
					var hasNeither = A2(
						_elm_lang$core$List$filter,
						function (es) {
							return (!A2(edgesContains, _p6.from, es)) && (!A2(edgesContains, _p6.to, es));
						},
						acc);
					var hasTo = A2(
						_elm_lang$core$List$filter,
						edgesContains(_p6.to),
						acc);
					var hasFrom = A2(
						_elm_lang$core$List$filter,
						edgesContains(_p6.from),
						acc);
					var _p4 = {ctor: '_Tuple2', _0: hasFrom, _1: hasTo};
					_v3_4:
					do {
						if (_p4.ctor === '_Tuple2') {
							if (_p4._0.ctor === '::') {
										...
										if (_p4._1._1.ctor === '[]') {
											var _v4 = _p7,
												...
												_0: {
													ctor: '::',
													_0: _p6,
													_1: A2(_elm_lang$core$Basics_ops['++'], _p4._0._0, _p4._1._0)
												},
												_1: hasNeither
											};
											edges = _v4;
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							start: {line: 1410, column: 25},
							end: {line: 1424, column: 57}
						},
						_p4)('impossible');
				}
			}
...
var _vito$cadet$Main$hexBrightness = function (h) {
	var _p9 = A2(_elm_lang$core$Basics$compare, h, (255 / 2) | 0);
	switch (_p9.ctor) {
		case 'LT':
			return -1;
		case 'EQ':
...
var _vito$cadet$Main$colorIsLight = function (hex) {
	...
	var _p10 = A2(
		...
		matches);
	if ((((((((_p10.ctor === 'Just') && (_p10._0.ctor === '::')) && (_p10._0._0.ctor === 'Just')) && (_p10._0._1.ctor === '::')) && (_p10._0._1._0.ctor === 'Just')) && (_p10._0._1._1.ctor === '::')) && (_p10._0._1._1._0.ctor === 'Just')) && (_p10._0._1._1._1.ctor === '[]')) {
		var _p11 = A2(
			_elm_lang$core$List$map,
			_fredcy$elm_parseint$ParseInt$parseIntHex,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _p10._0._1._1._0._0,
						_1: {ctor: '[]'}
					}
				}
			});
		if (((((((_p11.ctor === '::') && (_p11._0.ctor === 'Ok')) && (_p11._1.ctor === '::')) && (_p11._1._0.ctor === 'Ok')) && (_p11._1._1.ctor === '::')) && (_p11._1._1._0.ctor === 'Ok')) && (_p11._1._1._1.ctor === '[]')) {
			return (_elm_lang$core$Native_Utils.cmp(
				(_vito$cadet$Main$hexBrightness(_p11._0._0) + _vito$cadet$Main$hexBrightness(_p11._1._0._0)) + _vito$cadet$Main$hexBrightness(_p11._1._1._0._0),
				0) > 0) ? true : false;
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 1337, column: 17},
					end: {line: 1345, column: 50}
				},
				_p11)('invalid hex');
		}
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 1335, column: 9},
				end: {line: 1348, column: 42}
			},
			_p10)('invalid hex');
	}
};
var _vito$cadet$Main$viewLabel = function (_p14) {
	var _p15 = _p14;
	var _p16 = _p15.color;
	return A2(
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'background-color',
							_1: A2(_elm_lang$core$Basics_ops['++'], '#', _p16)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'color',
								_1: _vito$cadet$Main$colorIsLight(_p16) ? 'rgba(0, 0, 0, .8)' : '#fff'
							},
							_1: {ctor: '[]'}
						}
					}),
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('issue-label-text'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _vito$cadet$Main$isAnticipated = F2(
	function (model, iop) {
		...
		return A2(_elm_lang$core$List$member, id, model.anticipatedIssueOrPRs) && (!A2(_elm_lang$core$List$member, id, model.selectedIssueOrPRs));
	});
...
var _vito$cadet$Main$activityOpacity = F2(
	function (_p21, date) {
		var _p22 = _p21;
		var daysSinceLastUpdate = (_elm_lang$core$Date$toTime(_p22.currentDate) / (24 * _elm_lang$core$Time$hour)) - (_elm_lang$core$Date$toTime(date) / (24 * _elm_lang$core$Time$hour));
...
var _vito$cadet$Main$viewIssueActor = F2(
	function (model, _p23) {
		var _p24 = _p23;
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('issue-actor'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_0: {
								...
								_1: _elm_lang$core$Basics$toString(
									A2(_vito$cadet$Main$activityOpacity, model, _p24.createdAt))
							},
							_1: {ctor: '[]'}
						}),
					_1: {
...
var _vito$cadet$Main$viewIssueFlair = F2(
	function (model, _p25) {
		var _p26 = _p25;
		var _p28 = _p26.label;
		var uat = function () {
			var _p27 = _p28.value.issueOrPR;
			if (_p27.ctor === 'Issue') {
				return _p27._0.updatedAt;
			} else {
				return _p27._0.updatedAt;
			}
		}();
		...
		return A2(
			_elm_lang$svg$Svg$g,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$opacity(
					_elm_lang$core$Basics$toString(
						A2(_vito$cadet$Main$activityOpacity, model, uat) * 0.75)),
				_1: {
					ctor: '::',
...
var _vito$cadet$Main$issueRadius = function (_p29) {
	var _p30 = _p29;
...
var _vito$cadet$Main$issueRadiusWithLabels = function (_p31) {
	return A2(
		F2(
			function (x, y) {
				return x + y;
		...
		3,
		_vito$cadet$Main$issueRadius(_p31));
};
var _vito$cadet$Main$issueRadiusWithFlair = function (nc) {
	var reactions = function () {
		var _p32 = nc.node.label;
		if (_p32.ctor === 'Issue') {
			return _p32._0.reactions;
		} else {
			return _p32._0.reactions;
		}
	}();
	...
	var commentCount = function () {
		var _p33 = nc.node.label;
		if (_p33.ctor === 'Issue') {
			return _p33._0.commentCount;
		} else {
			return _p33._0.commentCount;
		}
	}();
	var highestFlair = A3(
		...
		0,
		{ctor: '::', _0: commentCount, _1: reactionCounts});
	return (_vito$cadet$Main$issueRadiusWithLabels(nc) + _vito$cadet$Main$flairRadiusBase) + _elm_lang$core$Basics$toFloat(highestFlair);
};
var _vito$cadet$Main$nodeFlairArcs = function (nc) {
	...
	var reactions = function () {
		var _p34 = nc.node.label;
		if (_p34.ctor === 'Issue') {
			return _p34._0.reactions;
		} else {
			return _p34._0.reactions;
		}
	}();
	var commentCount = function () {
		var _p35 = nc.node.label;
		if (_p35.ctor === 'Issue') {
			return _p35._0.commentCount;
		} else {
			return _p35._0.commentCount;
		}
	}();
	...
	var emojiReactions = A3(
		...
		function (_p37) {
			...
			return {
				ctor: '_Tuple2',
				_0: reactionTypeEmoji(_p38.type_),
				_1: _p38.count
			};
		});
	var flairs = A2(
		...
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: '💬', _1: commentCount},
			_1: emojiReactions
		});
	var radius = _vito$cadet$Main$issueRadiusWithLabels(nc);
		...
		function (i, _p40) {
			...
			var segments = A2(
				_gampleman$elm_visualization$Visualization_Shape$pie,
				{
					...
					innerRadius: radius,
					outerRadius: (radius + _vito$cadet$Main$flairRadiusBase) + _elm_lang$core$Basics$toFloat(_p41._1),
					cornerRadius: 3,
					padRadius: 0
				},
				A2(
			...
			if ((_p44.ctor === '::') && (_p44._1.ctor === '[]')) {
				return _p44._0;
			} else {
				return _elm_lang$core$Native_Utils.crashCase(
					'Main',
					{
						start: {line: 911, column: 17},
						end: {line: 916, column: 49}
					},
					_p44)('impossible');
			}
		});
	var issue = nc.node.label;
	return A3(
		_elm_lang$core$Basics$flip,
		_elm_lang$core$List$indexedMap,
		flairs,
		F2(
			function (i, _p46) {
				var _p47 = _p46;
				var arc = A2(reactionSegment, i, _p47);
				return A2(
					_elm_lang$svg$Svg$g,
					{
						ctor: '::',
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg$text(_p47._0),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _vito$cadet$Main$nodeLabelArcs = function (nc) {
	var radius = _vito$cadet$Main$issueRadius(nc);
	var labels = function () {
		var _p48 = nc.node.label;
		if (_p48.ctor === 'Issue') {
			return _p48._0.labels;
		} else {
			return _p48._0.labels;
		}
	}();
	var labelSegments = A2(
		...
		A2(
			_elm_lang$core$List$repeat,
			_elm_lang$core$List$length(labels),
			1));
	return A3(
		_elm_lang$core$List$map2,
		F2(
...
var _vito$cadet$Main$linkPath = F2(
	function (graph, edge) {
		var target = function () {
			...
			if (_p52.ctor === 'Just') {
				return {x: _p52._0.x, y: _p52._0.y};
			} else {
				return {x: 0, y: 0};
			}
		}();
		var source = function () {
			...
			if (_p54.ctor === 'Just') {
				return {x: _p54._0.x, y: _p54._0.y};
			} else {
				return {x: 0, y: 0};
			}
		}();
...
var _vito$cadet$Main$nodeScore = function (fn) {
	var _p55 = fn.value.issueOrPR;
	if (_p55.ctor === 'Issue') {
		return _vito$cadet$GitHubGraph$issueScore(_p55._0);
	} else {
		return _vito$cadet$GitHubGraph$pullRequestScore(_p55._0);
	}
};
			...
			var graphScore = function (_p57) {
				return A3(
					...
					A2(
						...
						_elm_community$graph$Graph$nodes(_p57)));
			};
			return A2(
				_elm_lang$core$Basics$compare,
				graphScore(a.graph),
...
var _vito$cadet$Main$setIssueOrPRSelected = F3(
	function (id, val, fg) {
		...
		var graphId = _vito$cadet$Hash$hash(id);
		return A2(_vito$cadet$ForceGraph$member, graphId, fg) ? A3(_vito$cadet$ForceGraph$update, graphId, toggle, fg) : fg;
	});
var _vito$cadet$Main$graphContainsIssuesInProject = F2(
	function (id, _p59) {
		var _p60 = _p59;
		var nodeIsInProject = function (_p61) {
			var _p62 = _p61;
			var cards = function () {
				var _p63 = _p62.label.value.issueOrPR;
				if (_p63.ctor === 'Issue') {
					return _p63._0.cards;
				} else {
					return _p63._0.cards;
				}
			}();
		...
		return A2(
			_elm_lang$core$List$any,
			nodeIsInProject,
			_elm_community$graph$Graph$nodes(_p60.graph));
	});
var _vito$cadet$Main$selectStatefulProject = function (project) {
	...
	var _p68 = {ctor: '_Tuple3', _0: backlog, _1: inFlight, _2: done};
	if ((((_p68.ctor === '_Tuple3') && (_p68._0.ctor === 'Just')) && (_p68._1.ctor === 'Just')) && (_p68._2.ctor === 'Just')) {
		return _elm_lang$core$Maybe$Just(
			{id: project.id, name: project.name, backlog: _p68._0._0, inFlight: _p68._1._0, done: _p68._2._0, problemSpace: rest});
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _vito$cadet$Main$delta2url = F2(
	function (a, b) {
		var withSelection = _rgrempel$elm_route_url$RouteUrl_Builder$replaceHash(
			A2(_elm_lang$core$String$join, ',', b.selectedIssueOrPRs));
					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {config: a, page: b, allIssueOrPRs: c, issueOrPRActors: d, issueOrPRGraphs: e, selectedIssueOrPRs: f, anticipatedIssueOrPRs: g, currentDate: h, projects: i, cards: j};
									};
								};
							};
						};
...
var _vito$cadet$Main$IssueOrPRNode = F5(
	function (a, b, c, d, e) {
		return {issueOrPR: a, flair: b, labels: c, radii: d, selected: e};
	});
var _vito$cadet$Main$ProjectState = F6(
	function (a, b, c, d, e, f) {
		return {id: a, name: b, backlog: c, inFlight: d, done: e, problemSpace: f};
	});
var _vito$cadet$Main$ClearSelectedIssueOrPRs = {ctor: 'ClearSelectedIssueOrPRs'};
var _vito$cadet$Main$SelectAnticipatedIssueOrPRs = {ctor: 'SelectAnticipatedIssueOrPRs'};
var _vito$cadet$Main$SearchIssueOrPRs = function (a) {
	return {ctor: 'SearchIssueOrPRs', _0: a};
};
var _vito$cadet$Main$viewSearch = A2(
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_vito$cadet$Main$ClearSelectedIssueOrPRs),
				_1: {
					ctor: '::',
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onSubmit(_vito$cadet$Main$SelectAnticipatedIssueOrPRs),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_vito$cadet$Main$SearchIssueOrPRs),
							_1: {
								ctor: '::',
...
var _vito$cadet$Main$UnanticipateIssueOrPR = function (a) {
	return {ctor: 'UnanticipateIssueOrPR', _0: a};
};
var _vito$cadet$Main$AnticipateIssueOrPR = function (a) {
	return {ctor: 'AnticipateIssueOrPR', _0: a};
};
var _vito$cadet$Main$DeselectIssueOrPR = function (a) {
	return {ctor: 'DeselectIssueOrPR', _0: a};
};
var _vito$cadet$Main$SelectIssueOrPR = function (a) {
	return {ctor: 'SelectIssueOrPR', _0: a};
};
var _vito$cadet$Main$viewIssueOrPRNode = F2(
	function (model, _p70) {
		var _p71 = _p70;
		var _p74 = _p71.label;
		var issueOrPR = _p74.value.issueOrPR;
		var id = function () {
			var _p72 = issueOrPR;
			if (_p72.ctor === 'Issue') {
				return _p72._0.id;
					...
					_0: A2(
						_elm_lang$svg$Svg$circle,
						{
							...
							_0: _elm_lang$svg$Svg_Attributes$r(
								_elm_lang$core$Basics$toString(_p74.value.radii.base)),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$fill('#fff'),
								_1: {ctor: '[]'}
						...
						_0: A2(
							...
							},
							{
								...
								_0: _elm_lang$svg$Svg$text(
									_elm_lang$core$Basics$toString(_p73._0.number)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
			...
			_elm_lang$svg$Svg$g,
			{
				...
				_1: {
					...
					_0: _elm_lang$svg$Svg_Events$onMouseOver(
						_vito$cadet$Main$AnticipateIssueOrPR(id)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Events$onMouseOut(
							_vito$cadet$Main$UnanticipateIssueOrPR(id)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Events$onClick(
								_p74.value.selected ? _vito$cadet$Main$DeselectIssueOrPR(id) : _vito$cadet$Main$SelectIssueOrPR(id)),
							_1: {ctor: '[]'}
						}
					}
				}
			},
			A2(_elm_lang$core$Basics_ops['++'], circleWithNumber, _p74.value.labels));
	});
var _vito$cadet$Main$viewGraph = F2(
	function (model, _p75) {
					...
					return {
						...
						_0: {
							...
							_0: A2(
								...
								_vito$cadet$Main$viewIssueFlair(model),
								_p82),
							_1: _p81._0
						},
						_1: {
							...
							_0: A2(
								_elm_lang$svg$Svg_Lazy$lazy,
								_vito$cadet$Main$viewIssueOrPRNode(model),
								_p82),
							_1: _p81._1
						}
					};
		...
		var links = A2(
			_elm_lang$core$List$map,
			_elm_lang$svg$Svg_Lazy$lazy(
				_vito$cadet$Main$linkPath(_p91)),
			_elm_community$graph$Graph$edges(_p91));
		var padding = 10;
		var nodeContexts = A3(
			_elm_community$graph$Graph$fold,
			F2(
		...
		var minX = A3(
			...
			F2(
				function (_p83, acc) {
					var _p84 = _p83;
					return A2(_elm_lang$core$Basics$min, _p84._0, acc);
				}),
			999999,
			bounds) - padding;
		var minY = A3(
			...
			F2(
				function (_p85, acc) {
					var _p86 = _p85;
					return A2(_elm_lang$core$Basics$min, _p86._1, acc);
				}),
			999999,
			bounds) - padding;
		var maxX = A3(
			...
			F2(
				function (_p87, acc) {
					var _p88 = _p87;
					return A2(_elm_lang$core$Basics$max, _p88._2, acc);
				}),
			0,
			bounds) + padding;
		var width = maxX - minX;
		var maxY = A3(
			...
			F2(
				function (_p89, acc) {
					var _p90 = _p89;
					return A2(_elm_lang$core$Basics$max, _p90._3, acc);
				}),
			0,
			bounds) + padding;
...
var _vito$cadet$Main$viewIssueCard = F2(
	function (model, iop) {
		var id = function () {
			var _p92 = iop;
			if (_p92.ctor === 'Issue') {
			...
			_elm_lang$html$Html$div,
			{
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'issue-card', _1: true},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'issue-info', _1: true},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: 'in-flight',
										_1: _vito$cadet$Main$isInFlight(iop)
									},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'done',
											_1: _vito$cadet$Main$isDone(iop)
										},
										_1: {
											ctor: '::',
											_0: {
												ctor: '_Tuple2',
												_0: 'backlog',
												_1: _vito$cadet$Main$isBacklog(iop)
											},
											_1: {
												ctor: '::',
												_0: {
													ctor: '_Tuple2',
													_0: 'anticipated',
													_1: A2(_vito$cadet$Main$isAnticipated, model, iop)
												},
												_1: {ctor: '[]'}
											}
										}
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_vito$cadet$Main$SelectIssueOrPR(id)),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('issue-actors'),
						_1: {ctor: '[]'}
					},
					A2(
						_elm_lang$core$List$map,
						_vito$cadet$Main$viewIssueActor(model),
						A2(_vito$cadet$Main$recentActors, model, iop))),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$a,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('issue-title'),
									_1: {ctor: '[]'}
								}
							}
						},
					...
					_1: {
						...
						_0: A2(
							...
							A2(_elm_lang$core$List$map, _vito$cadet$Main$viewLabel, labels)),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('issue-meta'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
												...
												_0: function () {
													...
													if (_p98.ctor === 'Just') {
														...
														return A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$href(_p99.url),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$target('_blank'),
																	_1: {ctor: '[]'}
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text(_p99.login),
																_1: {ctor: '[]'}
															});
													} else {
...
var _vito$cadet$Main$viewProjectColumnCard = F2(
	function (model, _p100) {
		var _p101 = _p100;
		var _p102 = {ctor: '_Tuple2', _0: _p101.note, _1: _p101.itemID};
		_v62_2:
		do {
			if (_p102.ctor === '_Tuple2') {
				if (_p102._0.ctor === 'Just') {
					if (_p102._1.ctor === 'Nothing') {
						return _elm_lang$html$Html$text('');
					} else {
						break _v62_2;
					}
				} else {
					if (_p102._1.ctor === 'Just') {
						var _p103 = A2(_elm_lang$core$Dict$get, _p102._1._0, model.allIssueOrPRs);
						if (_p103.ctor === 'Just') {
							return A2(_vito$cadet$Main$viewIssueCard, model, _p103._0);
						} else {
							return _elm_lang$html$Html$text('');
						}
					} else {
		...
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 487, column: 5},
				end: {line: 501, column: 37}
			},
			_p102)('impossible');
	});
var _vito$cadet$Main$viewProjectColumn = F2(
	function (model, _p105) {
		...
		var cards = A2(
			_elm_lang$core$Maybe$withDefault,
			{ctor: '[]'},
			A2(_elm_lang$core$Dict$get, _p106.id, model.cards));
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
...
var _vito$cadet$Main$viewSingleProject = F2(
	function (model, _p107) {
		var _p108 = _p107;
		var relevantGraphs = A2(
			_elm_lang$core$List$filter,
			_vito$cadet$Main$graphContainsIssuesInProject(_p108.id),
			model.issueOrPRGraphs);
		return A2(
			_elm_lang$html$Html$div,
			{
					...
					},
					{
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(_p108.name),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: A2(_vito$cadet$Main$viewProjectColumn, model, _p108.done),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: A2(_vito$cadet$Main$viewProjectColumn, model, _p108.inFlight),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: A2(_vito$cadet$Main$viewProjectColumn, model, _p108.backlog),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _vito$cadet$Main$viewProjectPage = F2(
	function (model, name) {
		var statefulProjects = A2(_elm_lang$core$List$filterMap, _vito$cadet$Main$selectStatefulProject, model.projects);
		...
		var _p110 = mproject;
		if (_p110.ctor === 'Just') {
			return A2(_vito$cadet$Main$viewSingleProject, model, _p110._0);
		} else {
			return _elm_lang$html$Html$text('project not found');
		}
	});
var _vito$cadet$Main$viewIssueInfo = F2(
	function (model, iop) {
		var anticipated = A2(_vito$cadet$Main$isAnticipated, model, iop);
		var labels = function () {
			var _p111 = iop;
			if (_p111.ctor === 'Issue') {
				return _p111._0.labels;
			} else {
				return _p111._0.labels;
			}
		}();
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('issue-controls'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('issue-buttons'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: (!anticipated) ? A2(
							_elm_lang$html$Html$span,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_vito$cadet$Main$DeselectIssueOrPR(id)),
								_1: {
									ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: A2(_vito$cadet$Main$viewIssueCard, model, iop),
					_1: {ctor: '[]'}
				}
			});
	});
			...
			_0: A2(
				...
				function (_p117) {
					return _vito$cadet$Main$SetCurrentDate(
						_elm_lang$core$Date$fromTime(_p117));
				}),
			_1: {
				ctor: '::',
...
var _vito$cadet$Main$viewProject = F2(
	function (model, _p118) {
		var _p119 = _p118;
		var _p120 = _p119.name;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
					...
					},
					{
										...
										_0: A2(
											_elm_lang$html$Html$a,
											{
												...
												_0: _elm_lang$html$Html_Attributes$href(
													A2(_elm_lang$core$Basics_ops['++'], '/projects/', _p120)),
												_1: {
													ctor: '::',
													_0: _vito$cadet$StrictEvents$onLeftClick(
														_vito$cadet$Main$SetPage(
															_vito$cadet$Main$ProjectPage(_p120))),
													_1: {ctor: '[]'}
												}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(_p120),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: A2(_vito$cadet$Main$viewProjectColumn, model, _p119.backlog),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: A2(_vito$cadet$Main$viewProjectColumn, model, _p119.inFlight),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: A2(_vito$cadet$Main$viewProjectColumn, model, _p119.done),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _vito$cadet$Main$init = function (config) {
	return {
		...
		_0: {
			...
			allIssueOrPRs: _elm_lang$core$Dict$empty,
...
var _vito$cadet$Main$view = function (model) {
	var selectedIssueOrPRs = A2(
		_elm_lang$core$List$map,
		_vito$cadet$Main$viewIssueInfo(model),
		A2(
			_elm_lang$core$List$filterMap,
			A2(_elm_lang$core$Basics$flip, _elm_lang$core$Dict$get, model.allIssueOrPRs),
			model.selectedIssueOrPRs));
	var anticipatedIssueOrPRs = A2(
		_elm_lang$core$List$map,
		_vito$cadet$Main$viewIssueInfo(model),
		A2(
			_elm_lang$core$List$filterMap,
			...
			A2(
				_elm_lang$core$List$filter,
				function (_p122) {
					return !A3(_elm_lang$core$Basics$flip, _elm_lang$core$List$member, model.selectedIssueOrPRs, _p122);
				},
				model.anticipatedIssueOrPRs)));
	var sidebarIssues = A2(_elm_lang$core$Basics_ops['++'], selectedIssueOrPRs, anticipatedIssueOrPRs);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
						...
						},
						{
							...
							_0: function () {
								...
								switch (_p123.ctor) {
									...
									default:
										return A2(_vito$cadet$Main$viewProjectPage, model, _p123._0);
								}
							}(),
							_1: {ctor: '[]'}
						}),
...
var _vito$cadet$Main$PR = function (a) {
	return {ctor: 'PR', _0: a};
};
var _vito$cadet$Main$Issue = function (a) {
	return {ctor: 'Issue', _0: a};
};
var _vito$cadet$Main$computeGraphs = F2(
	function (model, data) {
		var issueOrPRNode = function (i) {
			var id = function () {
				var _p124 = i;
				if (_p124.ctor === 'Issue') {
					return _p124._0.id;
		...
		var graph = A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$List$map,
					issueOrPRNode,
					_elm_lang$core$Dict$values(allIssueOrPRs)),
				references));
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{allIssueOrPRs: allIssueOrPRs, issueOrPRActors: data.actors, issueOrPRGraphs: issueOrPRGraphs, projects: data.projects, cards: data.cards}),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
		...
		switch (_p127.ctor) {
			...
			case 'SetCurrentDate':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{currentDate: _p127._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SearchIssueOrPRs':
				if (_p127._0 === '') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
					...
					var issueOrPRMatch = function (issueOrPR) {
						var title = function () {
							var _p128 = issueOrPR;
							if (_p128.ctor === 'Issue') {
								return _p128._0.title;
							} else {
								return _p128._0.title;
							}
						}();
						...
						return A2(
							...
							_elm_lang$core$String$toLower(_p127._0),
							_elm_lang$core$String$toLower(title)) ? _elm_lang$core$Maybe$Just(id) : _elm_lang$core$Maybe$Nothing;
					};
					var foundIssueOrPRs = A2(
						_elm_lang$core$List$filterMap,
						issueOrPRMatch,
						_elm_lang$core$Dict$values(model.allIssueOrPRs));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{anticipatedIssueOrPRs: foundIssueOrPRs}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'SelectAnticipatedIssueOrPRs':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							anticipatedIssueOrPRs: {ctor: '[]'},
							selectedIssueOrPRs: A2(_elm_lang$core$Basics_ops['++'], model.selectedIssueOrPRs, model.anticipatedIssueOrPRs)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SelectIssueOrPR':
				var _p130 = _p127._0;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							issueOrPRGraphs: A2(
								_elm_lang$core$List$map,
								A2(_vito$cadet$Main$setIssueOrPRSelected, _p130, true),
								model.issueOrPRGraphs),
							selectedIssueOrPRs: A2(_elm_lang$core$List$member, _p130, model.selectedIssueOrPRs) ? model.selectedIssueOrPRs : A2(
								_elm_lang$core$Basics_ops['++'],
								model.selectedIssueOrPRs,
								{
									ctor: '::',
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							issueOrPRGraphs: A2(
								_elm_lang$core$List$map,
								A2(_vito$cadet$Main$setIssueOrPRSelected, _p131, false),
								model.issueOrPRGraphs),
			...
			case 'AnticipateIssueOrPR':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							anticipatedIssueOrPRs: {ctor: '::', _0: _p127._0, _1: model.anticipatedIssueOrPRs}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UnanticipateIssueOrPR':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							anticipatedIssueOrPRs: A2(
								_elm_lang$core$List$filter,
								F2(
									function (x, y) {
										return !_elm_lang$core$Native_Utils.eq(x, y);
			...
			default:
				if (_p127._0.ctor === 'Ok') {
					var _p135 = _p127._0._0;
					var _p132 = A2(_vito$cadet$Main$computeGraphs, model, _p135);
					var graphedModel = _p132._0;
					var graphedMsg = _p132._1;
					var withIssues = A3(
						_elm_lang$core$Dict$foldl,
						F3(
							function (_p133, is, iops) {
								return A3(
									_elm_lang$core$List$foldl,
									function (i) {
										return A2(
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							graphedModel,
							{allIssueOrPRs: allIssueOrPRs, projects: _p135.projects, cards: _p135.cards}),
						_1: graphedMsg
					};
				} else {
					return A3(
						_elm_lang$core$Basics$flip,
						_elm_lang$core$Basics$always,
						A2(_elm_lang$core$Debug$log, 'error', _p127._0._0),
