			...
			switch (msg.$) {
				...
				case 'CommitAssignments':
					var cardAssignments = F2(
						function (cardId, _v11) {
							var assign = _v11.assign;
							var unassign = _v11.unassign;
							var _v10 = _Utils_Tuple2(assign, unassign);
							if (!_v10.a.b) {
								if (!_v10.b.b) {
									return _List_Nil;
								} else {
				...
				case 'EventReceived':
					...
					var data = _v14.b;
					var indexStr = _v14.c;
					var _v15 = $elm$core$String$toInt(indexStr);
					if (_v15.$ === 'Just') {
						var index = _v15.a;
				...
				case 'LabelCard':
					var card = msg.a;
					var label = msg.b;
					var _v25 = card.content;
					if (_v25.$ === 'IssueCardContent') {
						var issue = _v25.a;
						return _Utils_Tuple2(
							model,
							A3(
				...
				case 'UnlabelCard':
					var card = msg.a;
					var label = msg.b;
					var _v26 = card.content;
					if (_v26.$ === 'IssueCardContent') {
						var issue = _v26.a;
						return _Utils_Tuple2(
							model,
...
var $author$project$Main$viewLaneActors = F2(
	function (model, cards) {
		var assignDropCandidate = function (user) {
			return {msgFunc: $author$project$Model$AssignOnlyUser, target: user};
		};
			...
			function () {
				...
				if (_v0.$ === 'Just') {
					...
					return $elm$core$List$isEmpty(card.assignees) ? _List_fromArray(
						...
						]) : A2($elm$core$List$map, viewDraggableActor, card.assignees);
				} else {
					return _List_Nil;
				}
			}());
...
var $author$project$Main$viewPairsPage = function (model) {
	...
	var viewProjectLanes = function (_v0) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('project-cards')
				]),
			_List_fromArray(
				[
					A2(
