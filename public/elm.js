	...
	if ((((((((_p14.ctor === 'Just') && (_p14._0.ctor === '::')) && (_p14._0._0.ctor === 'Just')) && (_p14._0._1.ctor === '::')) && (_p14._0._1._0.ctor === 'Just')) && (_p14._0._1._1.ctor === '::')) && (_p14._0._1._1._0.ctor === 'Just')) && (_p14._0._1._1._1.ctor === '[]')) {
		...
		if (((((((_p15.ctor === '::') && (_p15._0.ctor === 'Ok')) && (_p15._1.ctor === '::')) && (_p15._1._0.ctor === 'Ok')) && (_p15._1._1.ctor === '::')) && (_p15._1._1._0.ctor === 'Ok')) && (_p15._1._1._1.ctor === '[]')) {
			...
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 2677, column: 17},
					end: {line: 2685, column: 50}
				},
				_p15)('invalid hex');
		}
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 2675, column: 9},
				end: {line: 2688, column: 42}
			},
			_p14)('invalid hex');
	}
};
			...
			var nextMilestoneCards = A3(
				...
				F3(
					function (_p87, card, acc) {
						return ((_vito$cadet$Main$isMerged(card) || A2(_vito$cadet$Main$isAccepted, model, card)) && _elm_lang$core$Native_Utils.eq(card.milestone, _elm_lang$core$Maybe$Nothing)) ? {ctor: '::', _0: card, _1: acc} : acc;
					}),
				{ctor: '[]'},
				model.allCards);
